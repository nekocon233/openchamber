...
Pair a device with a one-time QR code and connect through **Private Relay** without opening ports or exposing a public server. The connection is end-to-end encrypted and can be revoked at any time. Direct connections, LAN/VPN access, tunnels through Cloudflare, FRPC, or Ngrok, and SSH are also supported.
...
- [Tunnels](packages/docs/content/docs/tunnels.mdx)
