...
| `surface` | `panel` in der Leiste, `dialog` im Anhängen-Fenster, `page` im Vollbild |
...
| `NO_DIRECTORY` | ein relativer Dateipfad wurde ohne offenes Projekt verwendet |
| `NOT_FOUND` | `readFile` auf eine Datei, die nicht existiert |
