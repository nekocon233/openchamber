...
runtime rather than inlining it, or the handoff would see two copies. The same
module exports `readJsonFile` for the main process's persisted notification targets.
