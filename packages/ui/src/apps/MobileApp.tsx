  ...
  const deepLinkHandlers = React.useMemo(
    () => ({
      prepareForSession: () => {
        ...
        setOpenPlan(null);
        setPendingChangesDiff(null);
        if (!roomyForPanels) setSidebarOpen(false);
      },
      openSessions: () => {
    ...
    [isTabletLayout, openChangesSurface, openFilesSurface, openSettingsSurface, openSurface, roomyForPanels, setSettingsPage],
  );
