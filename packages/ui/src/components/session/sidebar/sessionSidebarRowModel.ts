...
export type SessionSidebarActivityKey = 'chats' | 'active-now' | 'timeline' | 'pinned';
...
export type SessionSidebarRenderContext = 'project' | 'recent' | 'timeline' | 'timeline-chat' | 'pinned';
