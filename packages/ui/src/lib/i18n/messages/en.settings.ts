...
export const settingsDict = {
  ...
  'settings.openchamber.visual.field.conciseTranscript': 'Claude Code-Style Transcript',
  'settings.openchamber.visual.field.conciseTranscriptAria': 'Show the chat in Claude Code style',
