...
export const settingsDict = {
  ...
  'settings.openchamber.tunnel.description': 'Configure secure remote access with quick links, managed Cloudflare tunnels, or FRPC.',
  'settings.openchamber.tunnel.field.frpcProxyType': 'FRPC proxy type',
  'settings.openchamber.tunnel.option.frpcProxyType.tcp': 'TCP',
  'settings.openchamber.tunnel.option.frpcProxyType.http': 'HTTP vhost',
  'settings.openchamber.tunnel.field.frpcServerAddress': 'FRPS server address',
  'settings.openchamber.tunnel.field.frpcServerAddressPlaceholder': 'IP address or hostname (e.g. 203.0.113.10)',
  'settings.openchamber.tunnel.field.frpcServerPort': 'FRPS control port',
  'settings.openchamber.tunnel.field.frpcRemotePort': 'FRPS remote port',
  'settings.openchamber.tunnel.field.frpcPublicUrl': 'Public HTTPS URL',
  'settings.openchamber.tunnel.field.frpcCustomDomain': 'FRPS custom domain',
  'settings.openchamber.tunnel.field.frpcCustomDomainPlaceholder': 'Vhost hostname (e.g. vhost.example.com)',
  'settings.openchamber.tunnel.field.frpcPublicHostname': 'Public hostname',
  'settings.openchamber.tunnel.field.frpcPublicHostnamePlaceholder': 'External hostname (e.g. openchamber.example.com)',
  'settings.openchamber.tunnel.field.frpcToken': 'FRPS token',
  'settings.openchamber.tunnel.field.savedFrpcTokenPlaceholder': 'Saved token available (optional to replace)',
  'settings.openchamber.tunnel.field.frpcLocalPort': 'Automatic local OpenChamber port',
  'settings.openchamber.tunnel.note.frpcProxyTypes': 'Configure a TCP port mapping or HTTP virtual-host tunnel through FRPS. No CA file needed — FRPS certificates are verified automatically against the host trust store.',
  'settings.openchamber.tunnel.note.frpcTcpMapping': 'FRPC forwards plain HTTP on the remote port. Enter the exact external HTTPS origin where your TLS terminator listens and forwards to that port.',
  'settings.openchamber.tunnel.note.frpcHttpVhost': 'FRPC registers the custom domain with FRPS. Caddy or another reverse proxy can route the public hostname to that FRPS vhost hostname.',
  'settings.openchamber.tunnel.toast.frpcEndpointRequired': 'Enter a valid FRPS server address, control port, remote port, and public HTTPS URL.',
  'settings.openchamber.tunnel.toast.frpcHttpEndpointRequired': 'Enter a valid FRPS server address, control port, custom domain, and public hostname.',
  'settings.openchamber.tunnel.toast.frpcTokenRequired': 'An FRPS token is required.',
  ...
  'settings.openchamber.portForward.title': 'Port forwarding',
  'settings.openchamber.portForward.info': 'Publishes a dev server running on the OpenChamber host under a hostname of its own, so a browser on another machine can open it. The desktop app tunnels a local port instead and does not need this.',
  'settings.openchamber.portForward.field.template': 'Forward host template',
  'settings.openchamber.portForward.field.templatePlaceholder': 'oc--{port}.example.com',
  'settings.openchamber.portForward.field.templateInfo': 'Must contain {port} exactly once. The tunnel in front of OpenChamber has to route the whole wildcard back here over HTTPS, and a certificate has to cover it. Cloudflare’s Universal SSL covers only one wildcard level, so keep the template at the same level as the OpenChamber hostname.',
  'settings.openchamber.portForward.rejected': 'That template was not accepted. It must be a bare hostname containing {port} exactly once, with no scheme, port, path, or wildcard.',
  'settings.openchamber.portForward.active': 'Forwarded ports',
  'settings.openchamber.portForward.activeEmpty': 'No ports are being forwarded.',
  'settings.openchamber.portForward.stop': 'Stop',
  'settings.openchamber.portForward.stopAria': 'Stop forwarding port {port}',
  'settings.openchamber.portForward.warning': 'A forwarded dev server is reachable by anyone who can reach OpenChamber. Forwards stop when OpenChamber restarts.',
  'settings.openchamber.portForward.unavailable': 'Could not read the port forwarding status.',
  ...
  'settings.notifications.page.toast.disableBackgroundFailed': 'Failed to disable background notifications',
  ...
  'settings.notifications.page.toast.backgroundDisabledCleanupFailed': 'Background notifications were disabled on this device, but the server registration could not be removed',
