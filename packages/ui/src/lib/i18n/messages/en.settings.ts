export const settingsDict = {
  ...
  'settings.openchamber.tunnel.description': 'Configure secure remote access through a supported tunnel provider.',
  ...
  'settings.openchamber.tunnel.field.frpcTrustedCaFile': 'Trusted CA certificate',
  ...
  'settings.openchamber.tunnel.note.frpcProxyTypes': 'Configure a TCP port mapping or HTTP virtual-host tunnel through FRPS.',
  ...
  'settings.openchamber.tunnel.toast.frpcTrustedCaRequired': 'A trusted CA certificate file is required to verify the FRPS server.',
