...
export const dict = {
  'chat.codexCommand.unsupported': "This Codex command or skill is unavailable here. Check the command menu, or run terminal commands in Codex CLI.",
  'chat.codexCommand.diff': "Review workspace changes",
  'chat.codexCommand.mention': "Mention a file or folder",
  'chat.codexCommand.agents': "Browse subagent sessions",
  'chat.codexCommand.fast': "Toggle Fast mode",
  'chat.codexCommand.plan': "Switch to plan mode, optionally with a prompt",
  'chat.codexCommand.resume': "Resume a saved session",
  'chat.codexCommand.fork': "Fork the current session",
  'chat.codexCommand.status': "Show session settings",
  'chat.codexCommand.skills': "Browse Codex skills",
  'chat.codexCommand.mcp': "Show Codex MCP servers and tools",
  'chat.codexCommand.ps': "Show background terminals",
  'chat.codexCommand.stop': "Stop background terminals",
  'chat.codexCommand.review': "Run a Codex code review",
  'chat.codexCommand.invalid': "Invalid arguments or unavailable option for {command}.",
  'chat.codexCommand.needsSession': "Open a Codex session before running this command.",
  'chat.codexCommand.empty': "No entries.",
  'chat.codexCommand.failed': "Could not run the Codex command.",
  ...
  'mobile.sessions.status.running': 'Running',
  ...
  'sessions.sidebar.activity.pinnedTitle': 'pinned',
  ...
  'chat.goal.dialog.budgetUnavailableCodex': 'Codex doesn\'t report token usage, so this goal can\'t have a token budget.',
  'chat.compaction.auto': 'Context compacted automatically',
  'chat.compaction.manual': 'Context compacted',
  'chat.compaction.summary': 'Summary of the earlier conversation',
  ...
  'chat.errorBoundary.chunkLoadDescription': 'A UI update failed to load completely. Refresh the page to load the latest chat interface.',
  ...
  'chat.errorBoundary.reloadAction': 'Refresh page',
  ...
  'chat.questionCard.planExitTitle': "Review plan",
  'chat.message.turnStopped': "This turn was stopped.",
  'chat.questionCard.planExitQuestion': "Approve this plan and start implementation?",
  'chat.questionCard.planExitApprove': "Approve and implement",
  'chat.questionCard.planExitKeepPlanning': "Keep planning",
  ...
  'chat.chatInput.actions.queueMessageAria': 'Stage message',
  ...
  'chat.chatInput.queuedMessages.title': 'Queued messages',
  'chat.chatInput.queuedMessages.toggleAria': 'Toggle queued messages',
  'chat.chatInput.queuedMessages.emptyText': 'Queued prompt',
  'chat.chatInput.queuedMessages.submitting': 'Sending…',
  'chat.chatInput.queuedMessages.queued': 'Queued',
  'chat.queuedMessage.queue': 'Queue',
  'chat.queuedMessage.queued': 'Queued',
  'chat.queuedMessage.unqueue': 'Cancel queue',
  'chat.queuedMessage.sendFailed': 'Message was not sent and remains staged.',
  ...
  'chat.chatInput.placeholder.nativeCli': '@ for files; # for snippets; / commands go straight to the CLI',
  'chat.chatInput.placeholder.nativeCliCompact': 'Use @ # for helpers',
  ...
  'chat.chatInput.toast.sendUnconfirmed': 'Send status unknown — the message may already have been sent. Check the conversation before retrying.',
  ...
  'chat.toolPart.concise.outputLinesOne': '1 line',
  'chat.toolPart.concise.outputLinesMany': '{count} lines',
  'chat.toolPart.concise.moreLinesOne': 'Show 1 more line',
  'chat.toolPart.concise.moreLinesMany': 'Show {count} more lines',
  'chat.toolPart.concise.fewerLines': 'Show fewer lines',
  'chat.toolPart.concise.toolCallsOne': '1 tool call',
  'chat.toolPart.concise.toolCallsMany': '{count} tool calls',
