...
export const dict = {
  ...
  'contextPanel.browser.devServers.remoteOnly': 'These run on the machine hosting OpenChamber. Forward one to open it here.',
  'contextPanel.browser.devServers.remoteOnlyUnconfigured': 'These run on the machine hosting OpenChamber. Set a forward host template in Settings to open them here.',
  'contextPanel.browser.portForward.start': 'Forward',
  'contextPanel.browser.portForward.starting': 'Starting…',
  'contextPanel.browser.portForward.stop': 'Stop forwarding',
  'contextPanel.browser.portForward.startFailed': 'Could not start the forward',
  'contextPanel.browser.portForward.stopFailed': 'Could not stop the forward',
  'contextPanel.browser.portForward.notForwarded': 'Port {port} is not being forwarded',
  'contextPanel.browser.portForward.notForwardedHint': 'It runs on the machine OpenChamber is on. Forward it to open it here.',
  'contextPanel.browser.portForward.unconfigured': 'Port forwarding is not set up',
  'contextPanel.browser.portForward.unconfiguredHint': 'Set a forward host template in Settings before opening a dev server from another machine.',
  'contextPanel.browser.portForward.exposureWarning': 'A forwarded dev server is reachable by anyone who can reach OpenChamber.',
  ...
  'chat.queuedMessage.title': 'Staged ({count})',
  ...
  'chat.queuedMessage.removeAria': 'Delete staged message',
  'chat.queuedMessage.reorderAria': 'Drag to reorder staged messages',
