...
export const dict = {
  ...
  'chat.queuedMessage.title': 'Drafts ({count})',
  'chat.queuedMessage.edit': 'Edit',
  'chat.queuedMessage.send': 'Send',
  'chat.queuedMessage.sendFailed': 'Draft was not sent and remains in drafts.',
  'chat.queuedMessage.removeAria': 'Delete draft',
  'chat.queuedMessage.reorderAria': 'Drag to reorder drafts',
  ...
  'chat.chatInput.actions.queueMessageAria': 'Save message as draft',
