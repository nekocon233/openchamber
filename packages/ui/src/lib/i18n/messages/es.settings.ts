...
export const settingsDict = {
  ...
  "settings.openchamber.tunnel.description": "Configura el acceso remoto seguro con enlaces rápidos, túneles gestionados de Cloudflare o FRPC.",
  ...
  "settings.openchamber.tunnel.field.frpcServerAddress": "Dirección del servidor FRPS",
  "settings.openchamber.tunnel.field.frpcServerAddressPlaceholder": "Dirección IP o nombre de host (p. ej., 203.0.113.10)",
  "settings.openchamber.tunnel.field.frpcServerPort": "Puerto de control de FRPS",
  "settings.openchamber.tunnel.field.frpcRemotePort": "Puerto remoto de FRPS",
  "settings.openchamber.tunnel.field.frpcPublicUrl": "URL HTTPS pública",
  "settings.openchamber.tunnel.field.frpcCustomDomain": "Dominio personalizado de FRPS",
  "settings.openchamber.tunnel.field.frpcCustomDomainPlaceholder": "Nombre del host virtual (p. ej., vhost.example.com)",
  "settings.openchamber.tunnel.field.frpcPublicHostname": "Nombre de host público",
  "settings.openchamber.tunnel.field.frpcPublicHostnamePlaceholder": "Nombre de host externo (p. ej., openchamber.example.com)",
  "settings.openchamber.tunnel.field.frpcToken": "Token de FRPS",
  "settings.openchamber.tunnel.field.savedFrpcTokenPlaceholder": "Hay un token guardado (opcional reemplazarlo)",
  "settings.openchamber.tunnel.field.frpcLocalPort": "Puerto local automático de OpenChamber",
  "settings.openchamber.tunnel.note.frpcProxyTypes": "Configura una asignación de puerto TCP o un túnel de host virtual HTTP mediante FRPS. No se necesita archivo CA; el certificado de FRPS se verifica automáticamente con el almacén de confianza del host.",
  "settings.openchamber.tunnel.note.frpcTcpMapping": "FRPC reenvía HTTP sin cifrar por el puerto remoto. Introduce el origen HTTPS externo exacto donde el terminador TLS escucha y reenvía a ese puerto.",
  "settings.openchamber.tunnel.note.frpcHttpVhost": "FRPC registra el dominio personalizado en FRPS. Caddy u otro proxy inverso puede dirigir el nombre de host público al nombre de host virtual de FRPS.",
  "settings.openchamber.tunnel.toast.frpcEndpointRequired": "Introduce una dirección de servidor FRPS, un puerto de control, un puerto remoto y una URL HTTPS pública válidos.",
  "settings.openchamber.tunnel.toast.frpcHttpEndpointRequired": "Introduce una dirección de servidor FRPS, un puerto de control, un dominio personalizado y un nombre de host público válidos.",
  "settings.openchamber.tunnel.toast.frpcTokenRequired": "Se requiere un token de FRPS.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.portForward.title": "Reenvío de puertos",
  "settings.openchamber.portForward.info": "Publica un servidor de desarrollo que corre en la máquina de OpenChamber bajo un nombre de host propio, para que un navegador de otra máquina pueda abrirlo. La aplicación de escritorio usa un túnel a un puerto local y no necesita esto.",
  "settings.openchamber.portForward.field.template": "Plantilla de host de reenvío",
  "settings.openchamber.portForward.field.templatePlaceholder": "oc--{port}.example.com",
  "settings.openchamber.portForward.field.templateInfo": "Debe contener {port} exactamente una vez. El túnel delante de OpenChamber tiene que enrutar todo el comodín hasta aquí por HTTPS, y un certificado tiene que cubrirlo. El SSL universal de Cloudflare solo cubre un nivel de comodín, así que mantén la plantilla al mismo nivel que el nombre de host de OpenChamber.",
  "settings.openchamber.portForward.rejected": "Esa plantilla no se aceptó. Debe ser un nombre de host simple que contenga {port} exactamente una vez, sin esquema, puerto, ruta ni comodín.",
  "settings.openchamber.portForward.active": "Puertos reenviados",
  "settings.openchamber.portForward.activeEmpty": "No se está reenviando ningún puerto.",
  "settings.openchamber.portForward.stop": "Detener",
  "settings.openchamber.portForward.stopAria": "Detener el reenvío del puerto {port}",
  "settings.openchamber.portForward.warning": "Un servidor de desarrollo reenviado es accesible para cualquiera que pueda llegar a OpenChamber. Los reenvíos se detienen cuando OpenChamber se reinicia.",
  "settings.openchamber.portForward.unavailable": "No se pudo leer el estado del reenvío de puertos.",
  ...
  "settings.notifications.page.toast.disableBackgroundFailed": "No se pudieron desactivar las notificaciones en segundo plano",
  ...
  "settings.notifications.page.toast.backgroundDisabledCleanupFailed": "Las notificaciones en segundo plano se desactivaron en este dispositivo, pero no se pudo eliminar el registro del servidor",
  ...
  "settings.openchamber.visual.section.followUpBehavior": "Comportamiento de los mensajes de seguimiento",
  "settings.openchamber.visual.section.followUpBehaviorAria": "Comportamiento de los mensajes de seguimiento",
  "settings.openchamber.visual.field.followUpBehaviorAria": "Comportamiento de los mensajes de seguimiento: {option}",
  "settings.openchamber.visual.field.followUpBehaviorDescription": "Elige qué ocurre al pulsar Intro en un mensaje de seguimiento mientras el agente sigue respondiendo.",
  "settings.openchamber.visual.option.followUpBehavior.steer.label": "Redirigir",
  "settings.openchamber.visual.option.followUpBehavior.queue.label": "Poner en cola",
