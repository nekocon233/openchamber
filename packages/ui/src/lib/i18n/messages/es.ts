...
export const dict: Record<I18nKey, string> = {
  ...
  "contextPanel.browser.devServers.remoteOnly": "Se ejecutan en la máquina que aloja OpenChamber. Reenvía uno para abrirlo aquí.",
  "contextPanel.browser.devServers.remoteOnlyUnconfigured": "Se ejecutan en la máquina que aloja OpenChamber. Define una plantilla de host de reenvío en Ajustes para abrirlos aquí.",
  "contextPanel.browser.portForward.start": "Reenviar",
  "contextPanel.browser.portForward.starting": "Iniciando…",
  "contextPanel.browser.portForward.stop": "Detener reenvío",
  "contextPanel.browser.portForward.startFailed": "No se pudo iniciar el reenvío",
  "contextPanel.browser.portForward.stopFailed": "No se pudo detener el reenvío",
  "contextPanel.browser.portForward.notForwarded": "El puerto {port} no se está reenviando",
  "contextPanel.browser.portForward.notForwardedHint": "Se ejecuta en la máquina donde está OpenChamber. Reenvíalo para abrirlo aquí.",
  "contextPanel.browser.portForward.unconfigured": "El reenvío de puertos no está configurado",
  "contextPanel.browser.portForward.unconfiguredHint": "Define una plantilla de host de reenvío en Ajustes antes de abrir un servidor de desarrollo de otra máquina.",
  "contextPanel.browser.portForward.exposureWarning": "Un servidor de desarrollo reenviado es accesible para cualquiera que pueda llegar a OpenChamber.",
  ...
  "chat.queuedMessage.title": "En espera ({count})",
  ...
  "chat.queuedMessage.removeAria": "Eliminar mensaje en espera",
  "chat.queuedMessage.reorderAria": "Arrastra para reordenar los mensajes en espera",
