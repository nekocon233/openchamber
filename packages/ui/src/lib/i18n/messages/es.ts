...
export const dict: Record<I18nKey, string> = {
  'chat.codexCommand.unsupported': "Este comando o habilidad de Codex no está disponible aquí. Consulta el menú de comandos o ejecuta los comandos de terminal en Codex CLI.",
  'chat.codexCommand.diff': "Revisar cambios del espacio de trabajo",
  'chat.codexCommand.mention': "Mencionar un archivo o carpeta",
  'chat.codexCommand.agents': "Explorar sesiones de subagentes",
  'chat.codexCommand.fast': "Activar o desactivar el modo rápido",
  'chat.codexCommand.plan': "Cambiar al modo de planificación, con una instrucción opcional",
  'chat.codexCommand.resume': "Reanudar una sesión guardada",
  'chat.codexCommand.fork': "Crear una rama de la sesión actual",
  'chat.codexCommand.status': "Mostrar la configuración de la sesión",
  'chat.codexCommand.skills': "Explorar habilidades de Codex",
  'chat.codexCommand.mcp': "Mostrar servidores y herramientas MCP de Codex",
  'chat.codexCommand.ps': "Mostrar terminales en segundo plano",
  'chat.codexCommand.stop': "Detener terminales en segundo plano",
  'chat.codexCommand.review': "Iniciar una revisión de código con Codex",
  'chat.codexCommand.invalid': "Argumentos no válidos u opción no disponible para {command}.",
  'chat.codexCommand.needsSession': "Abre una sesión de Codex antes de ejecutar este comando.",
  'chat.codexCommand.empty': "No hay entradas.",
  'chat.codexCommand.failed': "No se pudo ejecutar el comando de Codex.",
  ...
  "mobile.sessions.section.pinned": "Fijadas",
  "mobile.sessions.status.running": "En ejecución",
  ...
  "sessions.sidebar.activity.pinnedTitle": "fijadas",
  ...
  "chat.goal.dialog.budgetUnavailableCodex": "Codex no informa del uso de tokens, así que este objetivo no puede tener un presupuesto de tokens.",
  "chat.compaction.auto": "Contexto comprimido automáticamente",
  "chat.compaction.manual": "Contexto comprimido",
  "chat.compaction.summary": "Resumen de la conversación anterior",
  ...
  "chat.revert.toast.conversationOnly": "Solo se revirtió la conversación. No hay una instantánea de tus archivos anterior a este mensaje, así que se quedaron como estaban.",
  "chat.revert.toast.nativeFirstMessage": "Claude Code no puede revertir el primer mensaje de una sesión. Inicia una sesión nueva en su lugar.",
  "chat.revert.toast.nativeMidTurn": "Codex trabaja por turnos completos. Elige el mensaje con el que empezó este turno.",
  "chat.revert.toast.nativeBeforeCompaction": "Este mensaje es anterior a la última compresión. Claude Code solo puede revertir o crear una rama desde un mensaje posterior.",
  ...
  "chat.errorBoundary.chunkLoadDescription": "Una actualización de la interfaz no se cargó por completo. Actualiza la página para cargar la conversación más reciente.",
  ...
  "chat.errorBoundary.reloadAction": "Actualizar la página",
  ...
  'chat.questionCard.planExitTitle': "Revisar el plan",
  'chat.message.turnStopped': "Esta ejecución se ha detenido.",
  'chat.questionCard.planExitQuestion': "¿Aprobar este plan y comenzar la implementación?",
  'chat.questionCard.planExitApprove': "Aprobar e implementar",
  'chat.questionCard.planExitKeepPlanning': "Seguir en modo de planificación",
  ...
  "chat.chatInput.actions.queueMessageAria": "Poner el mensaje en espera",
  ...
  "chat.chatInput.queuedMessages.title": "Mensajes en cola",
  "chat.chatInput.queuedMessages.toggleAria": "Mostrar u ocultar mensajes en cola",
  "chat.chatInput.queuedMessages.emptyText": "Mensaje en cola",
  "chat.chatInput.queuedMessages.submitting": "Enviando…",
  "chat.chatInput.queuedMessages.queued": "En cola",
  "chat.queuedMessage.queue": "Encolar",
  "chat.queuedMessage.queued": "En cola",
  "chat.queuedMessage.unqueue": "Quitar de la cola",
  "chat.queuedMessage.sendFailed": "El mensaje no se envió y sigue en espera.",
  ...
  "chat.chatInput.placeholder.nativeCli": "@ para archivos; # para snippets; los comandos / van directamente a la CLI",
  "chat.chatInput.placeholder.nativeCliCompact": "Usa @ # para ayudas",
  ...
  "chat.chatInput.toast.sendUnconfirmed": "Estado de envío desconocido: es posible que el mensaje ya se haya enviado. Revisa la conversación antes de reintentar.",
  ...
  "chat.toolPart.concise.outputLinesOne": "1 línea",
  "chat.toolPart.concise.outputLinesMany": "{count} líneas",
  "chat.toolPart.concise.moreLinesOne": "Mostrar 1 línea más",
  "chat.toolPart.concise.moreLinesMany": "Mostrar {count} líneas más",
  "chat.toolPart.concise.fewerLines": "Mostrar menos líneas",
  "chat.toolPart.concise.toolCallsOne": "1 llamada a herramienta",
  "chat.toolPart.concise.toolCallsMany": "{count} llamadas a herramientas",
