...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Ajouter un appareil',
  ...
  'settings.openchamber.visual.field.conciseTranscript': 'Transcription façon Claude Code',
  'settings.openchamber.visual.field.conciseTranscriptAria': 'Afficher le chat façon Claude Code',
  'settings.openchamber.visual.field.conciseTranscriptInfo': 'Chaque appel d\'outil tient sur une ligne, avec un bref résultat en dessous. Cliquez sur un appel pour voir ses détails. Le modèle et la durée sous une réponse n\'apparaissent qu\'au survol.',
  'settings.openchamber.visual.field.transcriptFileChangesOnly': 'Afficher uniquement les modifications de fichiers',
  'settings.openchamber.visual.field.transcriptFileChangesOnlyAria': 'Afficher uniquement les modifications de fichiers dans la transcription façon Claude Code',
  'settings.openchamber.visual.field.transcriptFileChangesOnlyInfo': 'Les commandes, lectures de fichiers et recherches n\'apparaissent pas dans la conversation. Les réponses, le raisonnement et chaque modification de fichier avec son diff restent visibles. S\'applique à la transcription façon Claude Code.',
