...
export const dict = {
  ...
  'chat.queuedMessage.title': 'En attente ({count})',
  ...
  'chat.queuedMessage.removeAria': 'Supprimer le message en attente',
  'chat.queuedMessage.reorderAria': 'Faire glisser pour réorganiser les messages en attente',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Ils tournent sur la machine qui héberge OpenChamber. Redirigez-en un pour l’ouvrir ici.',
  'contextPanel.browser.devServers.remoteOnlyUnconfigured': 'Ils tournent sur la machine qui héberge OpenChamber. Définissez un modèle d’hôte de redirection dans les Paramètres pour les ouvrir ici.',
  'contextPanel.browser.portForward.start': 'Rediriger',
  'contextPanel.browser.portForward.starting': 'Démarrage…',
  'contextPanel.browser.portForward.stop': 'Arrêter la redirection',
  'contextPanel.browser.portForward.startFailed': 'Impossible de démarrer la redirection',
  'contextPanel.browser.portForward.stopFailed': 'Impossible d’arrêter la redirection',
  'contextPanel.browser.portForward.notForwarded': 'Le port {port} n’est pas redirigé',
  'contextPanel.browser.portForward.notForwardedHint': 'Il tourne sur la machine où se trouve OpenChamber. Redirigez-le pour l’ouvrir ici.',
  'contextPanel.browser.portForward.unconfigured': 'La redirection de ports n’est pas configurée',
  'contextPanel.browser.portForward.unconfiguredHint': 'Définissez un modèle d’hôte de redirection dans les Paramètres avant d’ouvrir un serveur de développement d’une autre machine.',
  'contextPanel.browser.portForward.exposureWarning': 'Un serveur de développement redirigé est accessible à toute personne pouvant atteindre OpenChamber.',
