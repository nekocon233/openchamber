...
export const dict = {
  'chat.codexCommand.unsupported': "Cette commande ou compétence Codex est indisponible ici. Consultez le menu des commandes ou exécutez les commandes de terminal dans Codex CLI.",
  'chat.codexCommand.diff': "Examiner les modifications du projet",
  'chat.codexCommand.mention': "Mentionner un fichier ou dossier",
  'chat.codexCommand.agents': "Parcourir les sessions des sous-agents",
  'chat.codexCommand.fast': "Activer ou désactiver le mode rapide",
  'chat.codexCommand.plan': "Passer en mode plan, avec une consigne facultative",
  'chat.codexCommand.resume': "Reprendre une session enregistrée",
  'chat.codexCommand.fork': "Créer une branche de la session actuelle",
  'chat.codexCommand.status': "Afficher les paramètres de la session",
  'chat.codexCommand.skills': "Parcourir les compétences Codex",
  'chat.codexCommand.mcp': "Afficher les serveurs et outils MCP de Codex",
  'chat.codexCommand.ps': "Afficher les terminaux en arrière-plan",
  'chat.codexCommand.stop': "Arrêter les terminaux en arrière-plan",
  'chat.codexCommand.review': "Lancer une revue de code avec Codex",
  'chat.codexCommand.invalid': "Arguments invalides ou option indisponible pour {command}.",
  'chat.codexCommand.needsSession': "Ouvrez une session Codex avant de lancer cette commande.",
  'chat.codexCommand.empty': "Aucune entrée.",
  'chat.codexCommand.failed': "Impossible de lancer la commande Codex.",
  ...
  'sessions.sidebar.activity.pinnedTitle': 'épinglées',
  ...
  'chat.goal.dialog.budgetUnavailableCodex': 'Codex ne communique pas sa consommation de tokens : cet objectif ne peut donc pas avoir de budget de tokens.',
  'chat.compaction.auto': 'Contexte compressé automatiquement',
  'chat.compaction.manual': 'Contexte compressé',
  'chat.compaction.summary': 'Résumé de la conversation précédente',
  ...
  'chat.errorBoundary.chunkLoadDescription': 'Une mise à jour de l\'interface n\'a pas pu se charger entièrement. Actualisez la page pour charger la dernière interface de discussion.',
  ...
  'chat.errorBoundary.reloadAction': 'Actualiser la page',
  ...
  'chat.questionCard.planExitTitle': "Vérifier le plan",
  'chat.message.turnStopped': "Cette exécution a été arrêtée.",
  'chat.questionCard.planExitQuestion': "Approuver ce plan et commencer sa mise en œuvre ?",
  'chat.questionCard.planExitApprove': "Approuver et mettre en œuvre",
  'chat.questionCard.planExitKeepPlanning': "Rester en mode planification",
  ...
  'chat.chatInput.actions.queueMessageAria': 'Mettre le message en attente',
  ...
  'chat.chatInput.queuedMessages.title': 'Messages en file d’attente',
  'chat.chatInput.queuedMessages.toggleAria': 'Afficher ou masquer les messages en file d’attente',
  'chat.chatInput.queuedMessages.emptyText': 'Message en file d’attente',
  'chat.chatInput.queuedMessages.submitting': 'Envoi…',
  'chat.chatInput.queuedMessages.queued': 'En file d’attente',
  'chat.queuedMessage.queue': 'Mettre en file',
  'chat.queuedMessage.queued': 'En file',
  'chat.queuedMessage.unqueue': 'Retirer de la file',
  'chat.queuedMessage.sendFailed': 'Le message n\'a pas été envoyé et reste en attente.',
  ...
  'chat.chatInput.placeholder.nativeCli': '@ pour les fichiers ; # pour les extraits ; les commandes / vont directement à la CLI',
  'chat.chatInput.placeholder.nativeCliCompact': 'Utiliser @ # pour les aides',
  ...
  'chat.chatInput.toast.sendUnconfirmed': 'État d\'envoi inconnu — le message a peut-être déjà été envoyé. Vérifiez la conversation avant de réessayer.',
  'chat.chatInput.toast.sessionStatusUnavailable': 'Impossible de confirmer si la session est inactive. Le message n\'a pas été envoyé. Vérifiez la connexion et réessayez.',
  ...
  'chat.toolPart.concise.outputLinesOne': '1 ligne',
  'chat.toolPart.concise.outputLinesMany': '{count} lignes',
  'chat.toolPart.concise.moreLinesOne': 'Afficher 1 ligne de plus',
  'chat.toolPart.concise.moreLinesMany': 'Afficher {count} lignes de plus',
  'chat.toolPart.concise.fewerLines': 'Afficher moins de lignes',
  'chat.toolPart.concise.toolCallsOne': '1 appel d\'outil',
  'chat.toolPart.concise.toolCallsMany': '{count} appels d\'outils',
  ...
  'mobile.sessions.section.pinned': 'Épinglées',
  'mobile.sessions.status.running': 'En cours',
