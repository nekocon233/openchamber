...
export const dict: Record<I18nKey, string> = {
  'chat.codexCommand.unsupported': "この Codex コマンドまたはスキルはここでは利用できません。コマンドメニューを確認するか、ターミナルのコマンドを Codex CLI で実行してください。",
  'chat.codexCommand.diff': "ワークスペースの変更を確認する",
  'chat.codexCommand.mention': "ファイルやフォルダーを指定する",
  'chat.codexCommand.agents': "サブエージェントのセッションを参照する",
  'chat.codexCommand.fast': "高速モードを切り替える",
  'chat.codexCommand.plan': "プランモードに切り替える。指示も指定できます",
  'chat.codexCommand.resume': "保存済みのセッションを再開する",
  'chat.codexCommand.fork': "現在のセッションを分岐する",
  'chat.codexCommand.status': "セッション設定を表示する",
  'chat.codexCommand.skills': "Codex のスキルを参照する",
  'chat.codexCommand.mcp': "Codex の MCP サーバーとツールを表示する",
  'chat.codexCommand.ps': "バックグラウンドのターミナルを表示する",
  'chat.codexCommand.stop': "バックグラウンドのターミナルを停止する",
  'chat.codexCommand.review': "Codex のコードレビューを実行する",
  'chat.codexCommand.invalid': "{command} の引数が無効か、指定したオプションが利用できません。",
  'chat.codexCommand.needsSession': "このコマンドを実行するには、Codex セッションを開いてください。",
  'chat.codexCommand.empty': "項目はありません。",
  'chat.codexCommand.failed': "Codex コマンドを実行できませんでした。",
  ...
  'mobile.sessions.status.running': '実行中',
  ...
  'sessions.sidebar.activity.pinnedTitle': 'ピン留め',
  ...
  'chat.goal.dialog.budgetUnavailableCodex': 'Codex はトークン使用量を報告しないため、この目標にはトークン予算を設定できません。',
  'chat.compaction.auto': 'コンテキストを自動で圧縮しました',
  'chat.compaction.manual': 'コンテキストを圧縮しました',
  'chat.compaction.summary': 'それまでの会話の要約',
  ...
  'chat.errorBoundary.chunkLoadDescription': 'UI の更新を完全に読み込めませんでした。ページを更新して最新のチャット画面を読み込んでください。',
  'chat.errorBoundary.sessionLabel': 'セッション',
  'chat.errorBoundary.detailsSummary': 'エラー詳細',
  'chat.errorBoundary.resetAction': 'チャットをリセット',
  'chat.errorBoundary.reloadAction': 'ページを更新',
  ...
  'chat.questionCard.planExitTitle': "計画の確認",
  'chat.message.turnStopped': "今回の実行は停止されました。",
  'chat.questionCard.planExitQuestion': "この計画を承認して実装を開始しますか？",
  'chat.questionCard.planExitApprove': "承認して実装する",
  'chat.questionCard.planExitKeepPlanning': "計画モードを維持する",
  ...
  'chat.chatInput.actions.queueMessageAria': 'メッセージを保留に追加',
  ...
  'chat.chatInput.queuedMessages.title': 'キューに入ったメッセージ',
  'chat.chatInput.queuedMessages.toggleAria': 'キューに入ったメッセージを切り替える',
  'chat.chatInput.queuedMessages.emptyText': 'キューに入ったプロンプト',
  'chat.chatInput.queuedMessages.submitting': '送信中…',
  'chat.chatInput.queuedMessages.queued': 'キュー待ち',
  'chat.queuedMessage.queue': 'キューに追加',
  'chat.queuedMessage.queued': 'キュー済み',
  'chat.queuedMessage.unqueue': 'キューを解除',
  'chat.queuedMessage.sendFailed': 'メッセージは送信されず、保留リストに残っています。',
  ...
  'chat.chatInput.placeholder.nativeCli': '@でファイル、#でスニペット、/コマンドはそのままCLIへ',
  'chat.chatInput.placeholder.nativeCliCompact': '@ # でヘルパーを使用',
  ...
  'chat.chatInput.toast.sendUnconfirmed': '送信状態が不明です。メッセージはすでに送信済みの可能性があります。会話を確認してから再試行してください。',
  'chat.chatInput.toast.sessionStatusUnavailable': 'セッションがアイドルか確認できませんでした。メッセージは送信されていません。接続を確認して再試行してください。',
  ...
  'chat.toolPart.concise.outputLinesOne': '1 行',
  'chat.toolPart.concise.outputLinesMany': '{count} 行',
  'chat.toolPart.concise.moreLinesOne': 'さらに 1 行を表示',
  'chat.toolPart.concise.moreLinesMany': 'さらに {count} 行を表示',
  'chat.toolPart.concise.fewerLines': '表示する行を減らす',
  'chat.toolPart.concise.toolCallsOne': 'ツール呼び出し 1 件',
  'chat.toolPart.concise.toolCallsMany': 'ツール呼び出し {count} 件',
  'chat.todo.total': '合計',
