...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.browser.devServers.remoteOnly': 'これらは OpenChamber を動かしているマシン上で動作しています。転送すればここで開けます。',
  'contextPanel.browser.devServers.remoteOnlyUnconfigured': 'これらは OpenChamber を動かしているマシン上で動作しています。ここで開くには、設定で転送ホストのテンプレートを指定してください。',
  'contextPanel.browser.portForward.start': '転送',
  'contextPanel.browser.portForward.starting': '開始中…',
  'contextPanel.browser.portForward.stop': '転送を停止',
  'contextPanel.browser.portForward.startFailed': '転送を開始できませんでした',
  'contextPanel.browser.portForward.stopFailed': '転送を停止できませんでした',
  'contextPanel.browser.portForward.notForwarded': 'ポート {port} は転送されていません',
  'contextPanel.browser.portForward.notForwardedHint': 'OpenChamber が動いているマシン上で動作しています。転送するとここで開けます。',
  'contextPanel.browser.portForward.unconfigured': 'ポート転送が設定されていません',
  'contextPanel.browser.portForward.unconfiguredHint': '別のマシンの開発サーバーを開くには、先に設定で転送ホストのテンプレートを指定してください。',
  'contextPanel.browser.portForward.exposureWarning': '転送した開発サーバーは、OpenChamber にアクセスできる人なら誰でも開けます。',
  ...
  'chat.queuedMessage.title': '保留（{count}）',
  ...
  'chat.queuedMessage.removeAria': '保留メッセージを削除',
  'chat.queuedMessage.reorderAria': 'ドラッグして保留メッセージを並び替え',
