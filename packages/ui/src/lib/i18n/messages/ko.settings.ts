...
export const settingsDict = {
  ...
  'settings.openchamber.tunnel.description': '빠른 링크, 관리형 Cloudflare 터널 또는 FRPC로 안전한 원격 접속을 설정하세요.',
  'settings.openchamber.tunnel.field.frpcProxyType': 'FRPC 프록시 유형',
  'settings.openchamber.tunnel.option.frpcProxyType.tcp': 'TCP',
  'settings.openchamber.tunnel.option.frpcProxyType.http': 'HTTP 가상 호스트',
  'settings.openchamber.tunnel.field.frpcServerAddress': 'FRPS 서버 주소',
  'settings.openchamber.tunnel.field.frpcServerAddressPlaceholder': 'IP 주소 또는 호스트 이름(예: 203.0.113.10)',
  'settings.openchamber.tunnel.field.frpcServerPort': 'FRPS 제어 포트',
  'settings.openchamber.tunnel.field.frpcRemotePort': 'FRPS 원격 포트',
  'settings.openchamber.tunnel.field.frpcPublicUrl': '공개 HTTPS URL',
  'settings.openchamber.tunnel.field.frpcCustomDomain': 'FRPS 사용자 지정 도메인',
  'settings.openchamber.tunnel.field.frpcCustomDomainPlaceholder': '가상 호스트 이름(예: vhost.example.com)',
  'settings.openchamber.tunnel.field.frpcPublicHostname': '공개 호스트 이름',
  'settings.openchamber.tunnel.field.frpcPublicHostnamePlaceholder': '외부 호스트 이름(예: openchamber.example.com)',
  'settings.openchamber.tunnel.field.frpcToken': 'FRPS 토큰',
  'settings.openchamber.tunnel.field.savedFrpcTokenPlaceholder': '저장된 토큰 있음(필요한 경우 교체)',
  'settings.openchamber.tunnel.field.frpcLocalPort': '자동 OpenChamber 로컬 포트',
  'settings.openchamber.tunnel.note.frpcProxyTypes': 'FRPS를 통해 TCP 포트 매핑 또는 HTTP 가상 호스트 터널을 구성합니다. CA 파일이 필요 없으며 FRPS 인증서는 호스트 신뢰 저장소로 자동 검증됩니다.',
  'settings.openchamber.tunnel.note.frpcTcpMapping': 'FRPC는 원격 포트에서 암호화되지 않은 HTTP를 전달합니다. TLS 종단점이 수신하고 해당 포트로 전달하는 정확한 외부 HTTPS 오리진을 입력하세요.',
  'settings.openchamber.tunnel.note.frpcHttpVhost': 'FRPC는 사용자 지정 도메인을 FRPS에 등록합니다. Caddy 또는 다른 리버스 프록시가 공개 호스트 이름을 해당 FRPS 가상 호스트 이름으로 라우팅할 수 있습니다.',
  'settings.openchamber.tunnel.toast.frpcEndpointRequired': '올바른 FRPS 서버 주소, 제어 포트, 원격 포트 및 공개 HTTPS URL을 입력하세요.',
  'settings.openchamber.tunnel.toast.frpcHttpEndpointRequired': '올바른 FRPS 서버 주소, 제어 포트, 사용자 지정 도메인 및 공개 호스트 이름을 입력하세요.',
  'settings.openchamber.tunnel.toast.frpcTokenRequired': 'FRPS 토큰이 필요합니다.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.portForward.title': '포트 전달',
  'settings.openchamber.portForward.info': 'OpenChamber 호스트에서 실행 중인 개발 서버를 전용 호스트 이름으로 게시해, 다른 컴퓨터의 브라우저에서 열 수 있게 합니다. 데스크톱 앱은 로컬 포트 터널을 사용하므로 이 설정이 필요 없습니다.',
  'settings.openchamber.portForward.field.template': '전달 호스트 템플릿',
  'settings.openchamber.portForward.field.templatePlaceholder': 'oc--{port}.example.com',
  'settings.openchamber.portForward.field.templateInfo': '{port}을(를) 정확히 한 번 포함해야 합니다. OpenChamber 앞단의 터널이 와일드카드 전체를 HTTPS로 여기까지 전달해야 하고, 인증서가 이를 포함해야 합니다. Cloudflare의 Universal SSL은 와일드카드 한 단계만 지원하므로 템플릿을 OpenChamber 호스트 이름과 같은 단계로 유지하세요.',
  'settings.openchamber.portForward.rejected': '해당 템플릿이 거부되었습니다. 스킴, 포트, 경로, 와일드카드가 없는 순수 호스트 이름이어야 하며 {port}을(를) 정확히 한 번 포함해야 합니다.',
  'settings.openchamber.portForward.active': '전달 중인 포트',
  'settings.openchamber.portForward.activeEmpty': '전달 중인 포트가 없습니다.',
  'settings.openchamber.portForward.stop': '중지',
  'settings.openchamber.portForward.stopAria': '포트 {port} 전달 중지',
  'settings.openchamber.portForward.warning': '전달된 개발 서버는 OpenChamber에 접근할 수 있는 누구나 열 수 있습니다. OpenChamber를 다시 시작하면 전달이 모두 중지됩니다.',
  'settings.openchamber.portForward.unavailable': '포트 전달 상태를 읽지 못했습니다.',
  ...
  'settings.notifications.page.toast.disableBackgroundFailed': '백그라운드 알림을 비활성화하지 못했습니다',
  ...
  'settings.notifications.page.toast.backgroundDisabledCleanupFailed': '이 기기에서는 백그라운드 알림을 비활성화했지만 서버 등록을 삭제하지 못했습니다',
  ...
  'settings.openchamber.visual.section.followUpBehavior': '후속 메시지 동작',
  'settings.openchamber.visual.section.followUpBehaviorAria': '후속 메시지 동작',
  'settings.openchamber.visual.field.followUpBehaviorAria': '후속 메시지 동작: {option}',
  'settings.openchamber.visual.field.followUpBehaviorDescription': '에이전트가 응답하는 동안 후속 메시지에서 Enter 키를 눌렀을 때의 동작을 선택하세요.',
  'settings.openchamber.visual.option.followUpBehavior.steer.label': '방향 전환',
  'settings.openchamber.visual.option.followUpBehavior.queue.label': '대기열에 추가',
