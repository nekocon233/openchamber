...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.visual.field.conciseTranscript': 'Claude Code 스타일 대화 기록',
  'settings.openchamber.visual.field.conciseTranscriptAria': 'Claude Code 스타일로 대화 표시',
  'settings.openchamber.visual.field.conciseTranscriptInfo': '각 도구 호출을 한 줄로 보여 주고, 그 아래에 짧은 결과를 표시합니다. 호출을 클릭하면 자세한 내용을 볼 수 있습니다. 답변 아래의 모델과 소요 시간은 마우스를 올렸을 때만 표시됩니다.',
  'settings.openchamber.visual.field.transcriptFileChangesOnly': '파일 변경 사항만 표시',
  'settings.openchamber.visual.field.transcriptFileChangesOnlyAria': 'Claude Code 스타일 대화 기록에서 파일 변경 사항만 표시',
  'settings.openchamber.visual.field.transcriptFileChangesOnlyInfo': '명령 실행, 파일 읽기, 검색은 대화에 표시되지 않습니다. 답변, 추론, 그리고 diff가 포함된 각 파일 변경은 그대로 남습니다. Claude Code 스타일 대화 기록에 적용됩니다.',
