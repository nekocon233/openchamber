export const settingsDict = {
  ...
  'settings.openchamber.tunnel.description': '지원되는 터널 공급자를 통해 안전한 원격 접속을 설정하세요.',
  ...
  'settings.openchamber.tunnel.field.frpcTrustedCaFile': '신뢰할 CA 인증서',
  ...
  'settings.openchamber.tunnel.note.frpcProxyTypes': 'FRPS를 통해 TCP 포트 매핑 또는 HTTP 가상 호스트 터널을 구성합니다.',
  ...
  'settings.openchamber.tunnel.toast.frpcTrustedCaRequired': 'FRPS 서버를 검증하려면 신뢰할 CA 인증서 파일이 필요합니다.',
