...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.queuedMessage.title': '초안 ({count})',
  'chat.queuedMessage.edit': '편집',
  'chat.queuedMessage.send': '보내기',
  'chat.queuedMessage.sendFailed': '초안이 전송되지 않았으며 그대로 저장되어 있습니다.',
  'chat.queuedMessage.removeAria': '초안 삭제',
  'chat.queuedMessage.reorderAria': '드래그하여 초안 순서 변경',
  ...
  'chat.chatInput.actions.queueMessageAria': '메시지를 초안으로 저장',
