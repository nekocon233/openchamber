...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.browser.devServers.remoteOnly': '이 서버들은 OpenChamber가 실행 중인 컴퓨터에 있습니다. 포트를 전달하면 여기서 열 수 있습니다.',
  'contextPanel.browser.devServers.remoteOnlyUnconfigured': '이 서버들은 OpenChamber가 실행 중인 컴퓨터에 있습니다. 여기서 열려면 설정에서 전달 호스트 템플릿을 지정하세요.',
  'contextPanel.browser.portForward.start': '전달',
  'contextPanel.browser.portForward.starting': '시작하는 중…',
  'contextPanel.browser.portForward.stop': '전달 중지',
  'contextPanel.browser.portForward.startFailed': '포트 전달을 시작하지 못했습니다',
  'contextPanel.browser.portForward.stopFailed': '포트 전달을 중지하지 못했습니다',
  'contextPanel.browser.portForward.notForwarded': '포트 {port}은(는) 전달되지 않았습니다',
  'contextPanel.browser.portForward.notForwardedHint': 'OpenChamber가 실행 중인 컴퓨터에 있습니다. 전달하면 여기서 열 수 있습니다.',
  'contextPanel.browser.portForward.unconfigured': '포트 전달이 설정되지 않았습니다',
  'contextPanel.browser.portForward.unconfiguredHint': '다른 컴퓨터의 개발 서버를 열려면 먼저 설정에서 전달 호스트 템플릿을 지정하세요.',
  'contextPanel.browser.portForward.exposureWarning': '전달된 개발 서버는 OpenChamber에 접근할 수 있는 누구나 열 수 있습니다.',
  ...
  'chat.queuedMessage.title': '보관 ({count})',
  'chat.queuedMessage.edit': '편집',
  'chat.queuedMessage.send': '볼기',
  ...
  'chat.queuedMessage.removeAria': '보관 메시지 삭제',
  'chat.queuedMessage.reorderAria': '드래그하여 보관 메시지 순서 변경',
