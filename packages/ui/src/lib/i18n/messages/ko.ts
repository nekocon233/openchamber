...
export const dict: Record<I18nKey, string> = {
  'chat.codexCommand.unsupported': "이 Codex 명령 또는 스킬은 여기서 사용할 수 없습니다. 명령 메뉴를 확인하거나 Codex CLI에서 터미널 명령을 실행하세요.",
  'chat.codexCommand.diff': "작업 공간 변경 사항 검토",
  'chat.codexCommand.mention': "파일 또는 폴더 언급",
  'chat.codexCommand.agents': "하위 에이전트 세션 탐색",
  'chat.codexCommand.fast': "빠른 모드 전환",
  'chat.codexCommand.plan': "계획 모드로 전환하고 선택적으로 지시 입력",
  'chat.codexCommand.resume': "저장된 세션 재개",
  'chat.codexCommand.fork': "현재 세션 분기",
  'chat.codexCommand.status': "세션 설정 표시",
  'chat.codexCommand.skills': "Codex 스킬 탐색",
  'chat.codexCommand.mcp': "Codex MCP 서버 및 도구 표시",
  'chat.codexCommand.ps': "백그라운드 터미널 표시",
  'chat.codexCommand.stop': "백그라운드 터미널 중지",
  'chat.codexCommand.review': "Codex 코드 검토 실행",
  'chat.codexCommand.invalid': "{command}의 인수가 잘못되었거나 해당 옵션을 사용할 수 없습니다.",
  'chat.codexCommand.needsSession': "이 명령을 실행하려면 Codex 세션을 여세요.",
  'chat.codexCommand.empty': "항목이 없습니다.",
  'chat.codexCommand.failed': "Codex 명령을 실행하지 못했습니다.",
  ...
  'mobile.sessions.section.pinned': '고정됨',
  'mobile.sessions.status.running': '실행 중',
  ...
  'sessions.sidebar.header.displayMode.showPinned': '고정 섹션 표시',
  ...
  'sessions.sidebar.activity.pinnedTitle': '고정됨',
  ...
  'chat.goal.dialog.budgetUnavailableCodex': 'Codex는 토큰 사용량을 보고하지 않으므로 이 목표에는 토큰 예산을 설정할 수 없습니다.',
  'chat.compaction.auto': '컨텍스트를 자동으로 압축했습니다',
  'chat.compaction.manual': '컨텍스트를 압축했습니다',
  'chat.compaction.summary': '이전 대화 요약',
  ...
  'chat.errorBoundary.chunkLoadDescription': 'UI 업데이트를 완전히 불러오지 못했습니다. 페이지를 새로고침해 최신 채팅 화면을 불러오세요.',
  'chat.errorBoundary.sessionLabel': '세션',
  'chat.errorBoundary.detailsSummary': '오류 상세',
  'chat.errorBoundary.resetAction': '채팅 초기화',
  'chat.errorBoundary.reloadAction': '페이지 새로고침',
  ...
  'chat.questionCard.planExitTitle': "계획 검토",
  'chat.message.turnStopped': "이번 실행이 중지되었습니다.",
  'chat.questionCard.planExitQuestion': "이 계획을 승인하고 구현을 시작할까요?",
  'chat.questionCard.planExitApprove': "승인하고 구현",
  'chat.questionCard.planExitKeepPlanning': "계획 모드 유지",
  ...
  'chat.chatInput.actions.queueMessageAria': '메시지를 보관에 추가',
  ...
  'chat.chatInput.queuedMessages.title': '대기 중인 메시지',
  'chat.chatInput.queuedMessages.toggleAria': '대기 중인 메시지 전환',
  'chat.chatInput.queuedMessages.emptyText': '대기 중인 프롬프트',
  'chat.chatInput.queuedMessages.submitting': '전송 중…',
  'chat.chatInput.queuedMessages.queued': '대기 중',
  'chat.queuedMessage.queue': '큐에 추가',
  'chat.queuedMessage.queued': '큐에 추가됨',
  'chat.queuedMessage.unqueue': '큐 취소',
  'chat.queuedMessage.sendFailed': '메시지가 전송되지 않았으며 보관 목록에 남아 있습니다.',
  ...
  'chat.chatInput.placeholder.nativeCli': '@ 파일; # 스니펫; / 명령은 CLI로 바로 전달',
  'chat.chatInput.placeholder.nativeCliCompact': '@ # 도우미 사용',
  ...
  'chat.chatInput.toast.sendUnconfirmed': '전송 상태를 확인할 수 없습니다. 메시지가 이미 전송되었을 수 있습니다. 대화를 확인한 후 다시 시도하세요.',
  'chat.chatInput.toast.sessionStatusUnavailable': '세션이 유휴 상태인지 확인할 수 없습니다. 메시지가 전송되지 않았습니다. 연결을 확인한 후 다시 시도하세요.',
  ...
  'chat.toolPart.concise.outputLinesOne': '1줄',
  'chat.toolPart.concise.outputLinesMany': '{count}줄',
  'chat.toolPart.concise.moreLinesOne': '1줄 더 보기',
  'chat.toolPart.concise.moreLinesMany': '{count}줄 더 보기',
  'chat.toolPart.concise.fewerLines': '줄 접기',
  'chat.toolPart.concise.toolCallsOne': '도구 호출 1회',
  'chat.toolPart.concise.toolCallsMany': '도구 호출 {count}회',
  'chat.todo.total': '전체',
