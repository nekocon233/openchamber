...
export const settingsDict = {
  ...
  'settings.openchamber.portForward.title': 'Przekierowanie portów',
  'settings.openchamber.portForward.info': 'Publikuje serwer deweloperski działający na komputerze z OpenChamber pod własną nazwą hosta, aby przeglądarka na innym komputerze mogła go otworzyć. Aplikacja desktopowa korzysta z tunelu do lokalnego portu i tego nie potrzebuje.',
  'settings.openchamber.portForward.field.template': 'Szablon hosta przekierowania',
  'settings.openchamber.portForward.field.templatePlaceholder': 'oc--{port}.example.com',
  'settings.openchamber.portForward.field.templateInfo': 'Musi zawierać {port} dokładnie raz. Tunel przed OpenChamber musi kierować cały symbol wieloznaczny tutaj przez HTTPS, a certyfikat musi go obejmować. Universal SSL od Cloudflare obejmuje tylko jeden poziom symbolu wieloznacznego, więc utrzymaj szablon na tym samym poziomie co nazwa hosta OpenChamber.',
  'settings.openchamber.portForward.rejected': 'Ten szablon nie został zaakceptowany. Musi być czystą nazwą hosta zawierającą {port} dokładnie raz, bez schematu, portu, ścieżki ani symbolu wieloznacznego.',
  'settings.openchamber.portForward.active': 'Przekierowane porty',
  'settings.openchamber.portForward.activeEmpty': 'Żaden port nie jest przekierowany.',
  'settings.openchamber.portForward.stop': 'Zatrzymaj',
  'settings.openchamber.portForward.stopAria': 'Zatrzymaj przekierowanie portu {port}',
  'settings.openchamber.portForward.warning': 'Przekierowany serwer deweloperski jest dostępny dla każdego, kto może połączyć się z OpenChamber. Przekierowania kończą się po ponownym uruchomieniu OpenChamber.',
  'settings.openchamber.portForward.unavailable': 'Nie udało się odczytać stanu przekierowania portów.',
  ...
  'settings.notifications.page.toast.backgroundDisabledCleanupFailed': 'Powiadomienia w tle zostały wyłączone na tym urządzeniu, ale nie udało się usunąć rejestracji z serwera',
  'settings.notifications.page.toast.backgroundEnabled': 'Powiadomienia w tle zostały włączone',
  'settings.notifications.page.toast.disableBackgroundFailed': 'Nie udało się wyłączyć powiadomień w tle',
  ...
  'settings.openchamber.tunnel.description': 'Skonfiguruj bezpieczny dostęp zdalny przez obsługiwanego dostawcę tunelu.',
  'settings.openchamber.tunnel.field.frpcProxyType': 'Typ proxy FRPC',
  'settings.openchamber.tunnel.option.frpcProxyType.tcp': 'TCP',
  'settings.openchamber.tunnel.option.frpcProxyType.http': 'Wirtualny host HTTP',
  'settings.openchamber.tunnel.field.frpcServerAddress': 'Adres serwera FRPS',
  'settings.openchamber.tunnel.field.frpcServerAddressPlaceholder': 'Adres IP lub nazwa hosta (np. 203.0.113.10)',
  'settings.openchamber.tunnel.field.frpcServerPort': 'Port sterujący FRPS',
  'settings.openchamber.tunnel.field.frpcRemotePort': 'Port zdalny FRPS',
  'settings.openchamber.tunnel.field.frpcPublicUrl': 'Publiczny adres URL HTTPS',
  'settings.openchamber.tunnel.field.frpcCustomDomain': 'Niestandardowa domena FRPS',
  'settings.openchamber.tunnel.field.frpcCustomDomainPlaceholder': 'Nazwa wirtualnego hosta (np. vhost.example.com)',
  'settings.openchamber.tunnel.field.frpcPublicHostname': 'Publiczna nazwa hosta',
  'settings.openchamber.tunnel.field.frpcPublicHostnamePlaceholder': 'Zewnętrzna nazwa hosta (np. openchamber.example.com)',
  'settings.openchamber.tunnel.field.frpcToken': 'Token FRPS',
  'settings.openchamber.tunnel.field.savedFrpcTokenPlaceholder': 'Dostępny zapisany token (opcjonalnie zastąp)',
  'settings.openchamber.tunnel.field.frpcLocalPort': 'Automatyczny lokalny port OpenChamber',
  'settings.openchamber.tunnel.note.frpcProxyTypes': 'Skonfiguruj mapowanie portu TCP lub tunel wirtualnego hosta HTTP przez FRPS. Plik CA nie jest wymagany — certyfikat FRPS jest weryfikowany automatycznie przy użyciu magazynu zaufania hosta.',
  'settings.openchamber.tunnel.note.frpcTcpMapping': 'FRPC przekazuje nieszyfrowany ruch HTTP przez port zdalny. Podaj dokładne zewnętrzne źródło HTTPS, na którym terminator TLS nasłuchuje i przekazuje ruch do tego portu.',
  'settings.openchamber.tunnel.note.frpcHttpVhost': 'FRPC rejestruje niestandardową domenę w FRPS. Caddy lub inny odwrotny serwer proxy może kierować publiczną nazwę hosta do tej nazwy wirtualnego hosta FRPS.',
  'settings.openchamber.tunnel.toast.frpcEndpointRequired': 'Wprowadź prawidłowy adres serwera FRPS, port sterujący, port zdalny i publiczny adres URL HTTPS.',
  'settings.openchamber.tunnel.toast.frpcHttpEndpointRequired': 'Wprowadź prawidłowy adres serwera FRPS, port sterujący, niestandardową domenę i publiczną nazwę hosta.',
  'settings.openchamber.tunnel.toast.frpcTokenRequired': 'Token FRPS jest wymagany.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.openchamber.visual.section.followUpBehavior': 'Zachowanie wiadomości uzupełniających',
  'settings.openchamber.visual.section.followUpBehaviorAria': 'Zachowanie wiadomości uzupełniających',
  'settings.openchamber.visual.field.followUpBehaviorAria': 'Zachowanie wiadomości uzupełniających: {option}',
  'settings.openchamber.visual.field.followUpBehaviorDescription': 'Wybierz, co ma się stać po naciśnięciu Enter w wiadomości uzupełniającej, gdy agent nadal odpowiada.',
  'settings.openchamber.visual.option.followUpBehavior.steer.label': 'Pokieruj',
  'settings.openchamber.visual.option.followUpBehavior.queue.label': 'Dodaj do kolejki',
