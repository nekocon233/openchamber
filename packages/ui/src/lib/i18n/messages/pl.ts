...
export const dict: Record<I18nKey, string> = {
  'chat.codexCommand.unsupported': "To polecenie lub umiejętność Codex nie jest tutaj dostępne. Sprawdź menu poleceń lub uruchom polecenia terminala w Codex CLI.",
  'chat.codexCommand.diff': "Przejrzyj zmiany w obszarze roboczym",
  'chat.codexCommand.mention': "Wskaż plik lub folder",
  'chat.codexCommand.agents': "Przeglądaj sesje podagentów",
  'chat.codexCommand.fast': "Przełącz tryb szybki",
  'chat.codexCommand.plan': "Przejdź do trybu planowania z opcjonalnym poleceniem",
  'chat.codexCommand.resume': "Wznów zapisaną sesję",
  'chat.codexCommand.fork': "Utwórz odgałęzienie bieżącej sesji",
  'chat.codexCommand.status': "Pokaż ustawienia sesji",
  'chat.codexCommand.skills': "Przeglądaj umiejętności Codex",
  'chat.codexCommand.mcp': "Pokaż serwery i narzędzia MCP Codex",
  'chat.codexCommand.ps': "Pokaż terminale w tle",
  'chat.codexCommand.stop': "Zatrzymaj terminale w tle",
  'chat.codexCommand.review': "Uruchom przegląd kodu Codex",
  'chat.codexCommand.invalid': "Nieprawidłowe argumenty lub niedostępna opcja dla {command}.",
  'chat.codexCommand.needsSession': "Otwórz sesję Codex przed wykonaniem tego polecenia.",
  'chat.codexCommand.empty': "Brak wpisów.",
  'chat.codexCommand.failed': "Nie udało się wykonać polecenia Codex.",
  ...
  'mobile.sessions.section.pinned': 'Przypięte',
  'mobile.sessions.status.running': 'W toku',
  ...
  'sessions.sidebar.activity.pinnedTitle': 'przypięte',
  ...
  'chat.errorBoundary.chunkLoadDescription': 'Aktualizacja interfejsu nie wczytała się w całości. Odśwież stronę, aby wczytać najnowszy interfejs czatu.',
  ...
  'chat.errorBoundary.reloadAction': 'Odśwież stronę',
  ...
  'chat.questionCard.planExitTitle': "Przejrzyj plan",
  'chat.message.turnStopped': "Bieżące wykonanie zostało zatrzymane.",
  'chat.questionCard.planExitQuestion': "Zatwierdzić ten plan i rozpocząć realizację?",
  'chat.questionCard.planExitApprove': "Zatwierdź i wykonaj",
  'chat.questionCard.planExitKeepPlanning': "Pozostań w trybie planowania",
  ...
  'chat.chatInput.actions.queueMessageAria': 'Dodaj wiadomość do oczekujących',
  ...
  'chat.chatInput.queuedMessages.title': 'Wiadomości w kolejce',
  'chat.chatInput.queuedMessages.toggleAria': 'Przełącz wiadomości w kolejce',
  'chat.chatInput.queuedMessages.emptyText': 'Monit w kolejce',
  'chat.chatInput.queuedMessages.submitting': 'Wysyłanie…',
  'chat.chatInput.queuedMessages.queued': 'W kolejce',
  'chat.queuedMessage.queue': 'Do kolejki',
  'chat.queuedMessage.queued': 'W kolejce',
  'chat.queuedMessage.unqueue': 'Usuń z kolejki',
  'chat.queuedMessage.sendFailed': 'Nie udało się wysłać wiadomości. Pozostaje na liście oczekujących.',
  ...
  'chat.chatInput.placeholder.nativeCli': '@ dla plików; # dla fragmentów; polecenia / trafiają prosto do CLI',
  'chat.chatInput.placeholder.nativeCliCompact': 'Użyj @ # dla pomocników',
  ...
  'chat.chatInput.toast.sendUnconfirmed': 'Nieznany status wysyłania — wiadomość mogła już zostać wysłana. Sprawdź rozmowę przed ponowną próbą.',
  ...
  'chat.toolPart.concise.outputLinesOne': '1 wiersz',
  'chat.toolPart.concise.outputLinesMany': 'Wiersze: {count}',
  'chat.toolPart.concise.moreLinesOne': 'Pokaż jeszcze 1 wiersz',
  'chat.toolPart.concise.moreLinesMany': 'Pokaż więcej wierszy: {count}',
  'chat.toolPart.concise.fewerLines': 'Pokaż mniej wierszy',
  'chat.toolPart.concise.toolCallsOne': '1 wywołanie narzędzia',
  'chat.toolPart.concise.toolCallsMany': 'Wywołania narzędzi: {count}',
  ...
  'chat.goal.dialog.budgetUnavailableCodex': 'Codex nie raportuje zużycia tokenów, więc ten cel nie może mieć budżetu tokenów.',
  'chat.compaction.auto': 'Kontekst skompresowany automatycznie',
  'chat.compaction.manual': 'Kontekst skompresowany',
  'chat.compaction.summary': 'Podsumowanie wcześniejszej rozmowy',
