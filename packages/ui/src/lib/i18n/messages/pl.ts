...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.queuedMessage.title': 'Oczekujące ({count})',
  'chat.queuedMessage.edit': 'Edytuj',
  'chat.queuedMessage.send': 'Wyślij',
  ...
  'chat.queuedMessage.removeAria': 'Usuń oczekującą wiadomość',
  'chat.queuedMessage.reorderAria': 'Przeciągnij, aby zmienić kolejność oczekujących wiadomości',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Działają na komputerze, na którym uruchomiony jest OpenChamber. Przekieruj jeden, aby otworzyć go tutaj.',
  'contextPanel.browser.devServers.remoteOnlyUnconfigured': 'Działają na komputerze, na którym uruchomiony jest OpenChamber. Ustaw szablon hosta przekierowania w Ustawieniach, aby otworzyć je tutaj.',
  'contextPanel.browser.portForward.start': 'Przekieruj',
  'contextPanel.browser.portForward.starting': 'Uruchamianie…',
  'contextPanel.browser.portForward.stop': 'Zatrzymaj przekierowanie',
  'contextPanel.browser.portForward.startFailed': 'Nie udało się uruchomić przekierowania',
  'contextPanel.browser.portForward.stopFailed': 'Nie udało się zatrzymać przekierowania',
  'contextPanel.browser.portForward.notForwarded': 'Port {port} nie jest przekierowany',
  'contextPanel.browser.portForward.notForwardedHint': 'Działa na komputerze, na którym jest OpenChamber. Przekieruj go, aby otworzyć tutaj.',
  'contextPanel.browser.portForward.unconfigured': 'Przekierowanie portów nie jest skonfigurowane',
  'contextPanel.browser.portForward.unconfiguredHint': 'Ustaw szablon hosta przekierowania w Ustawieniach, zanim otworzysz serwer deweloperski z innego komputera.',
  'contextPanel.browser.portForward.exposureWarning': 'Przekierowany serwer deweloperski jest dostępny dla każdego, kto może połączyć się z OpenChamber.',
