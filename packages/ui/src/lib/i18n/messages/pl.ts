...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.queuedMessage.title': 'Wersje robocze ({count})',
  'chat.queuedMessage.edit': 'Edytuj',
  'chat.queuedMessage.send': 'Wyślij',
  'chat.queuedMessage.sendFailed': 'Nie udało się wysłać wersji roboczej. Nadal jest zapisana.',
  'chat.queuedMessage.removeAria': 'Usuń wersję roboczą',
  'chat.queuedMessage.reorderAria': 'Przeciągnij, aby zmienić kolejność wersji roboczych',
  ...
  'chat.chatInput.actions.queueMessageAria': 'Zapisz wiadomość jako wersję roboczą',
