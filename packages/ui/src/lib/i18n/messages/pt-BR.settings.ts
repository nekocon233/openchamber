...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.visual.field.conciseTranscript": "Transcrição no estilo Claude Code",
  "settings.openchamber.visual.field.conciseTranscriptAria": "Mostrar o chat no estilo Claude Code",
