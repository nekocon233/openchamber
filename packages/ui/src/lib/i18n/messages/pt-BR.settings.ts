...
export const settingsDict = {
  'settings.chat.execution.title': 'Execução de tarefas',
  'settings.chat.execution.label': 'Ambiente de execução',
  'settings.chat.execution.info': 'O Claude Code usa o modelo escolhido e seu login existente no provedor. Compatível com ChatGPT, Kimi Code, Anthropic e provedores compatíveis configurados. Vale a partir da próxima mensagem nas conversas existentes; tarefas em andamento terminam primeiro. Modelos incompatíveis exibem um erro.',
  'settings.chat.execution.unavailable': 'Requer um servidor OpenCode gerenciado pelo OpenChamber.',
  'settings.chat.execution.failed': 'Não foi possível salvar esta configuração. Tente novamente.',
  ...
  "settings.openchamber.tunnel.description": "Configure acesso remoto seguro com links rápidos, túneis gerenciados da Cloudflare ou FRPC.",
  "settings.openchamber.tunnel.field.frpcProxyType": "Tipo de proxy FRPC",
  "settings.openchamber.tunnel.option.frpcProxyType.tcp": "TCP",
  "settings.openchamber.tunnel.option.frpcProxyType.http": "Host virtual HTTP",
  "settings.openchamber.tunnel.field.frpcServerAddress": "Endereço do servidor FRPS",
  "settings.openchamber.tunnel.field.frpcServerAddressPlaceholder": "Endereço IP ou nome do host (ex.: 203.0.113.10)",
  "settings.openchamber.tunnel.field.frpcServerPort": "Porta de controle do FRPS",
  "settings.openchamber.tunnel.field.frpcRemotePort": "Porta remota do FRPS",
  "settings.openchamber.tunnel.field.frpcPublicUrl": "URL HTTPS pública",
  "settings.openchamber.tunnel.field.frpcCustomDomain": "Domínio personalizado do FRPS",
  "settings.openchamber.tunnel.field.frpcCustomDomainPlaceholder": "Nome do host virtual (ex.: vhost.example.com)",
  "settings.openchamber.tunnel.field.frpcPublicHostname": "Nome do host público",
  "settings.openchamber.tunnel.field.frpcPublicHostnamePlaceholder": "Nome do host externo (ex.: openchamber.example.com)",
  "settings.openchamber.tunnel.field.frpcToken": "Token do FRPS",
  "settings.openchamber.tunnel.field.savedFrpcTokenPlaceholder": "Token salvo disponível (substituição opcional)",
  "settings.openchamber.tunnel.field.frpcLocalPort": "Porta local automática do OpenChamber",
  "settings.openchamber.tunnel.note.frpcProxyTypes": "Configure um mapeamento de porta TCP ou um túnel de host virtual HTTP pelo FRPS. Nenhum arquivo CA é necessário; o certificado do FRPS é verificado automaticamente usando o repositório de confiança do host.",
  "settings.openchamber.tunnel.note.frpcTcpMapping": "O FRPC encaminha HTTP sem criptografia pela porta remota. Informe a origem HTTPS externa exata em que o terminador TLS escuta e encaminha para essa porta.",
  "settings.openchamber.tunnel.note.frpcHttpVhost": "O FRPC registra o domínio personalizado no FRPS. O Caddy ou outro proxy reverso pode encaminhar o nome do host público para esse nome de host virtual do FRPS.",
  "settings.openchamber.tunnel.toast.frpcEndpointRequired": "Informe um endereço de servidor FRPS, uma porta de controle, uma porta remota e uma URL HTTPS pública válidos.",
  "settings.openchamber.tunnel.toast.frpcHttpEndpointRequired": "Informe um endereço de servidor FRPS, uma porta de controle, um domínio personalizado e um nome de host público válidos.",
  "settings.openchamber.tunnel.toast.frpcTokenRequired": "É necessário um token do FRPS.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.portForward.title": "Encaminhamento de portas",
  "settings.openchamber.portForward.info": "Publica um servidor de desenvolvimento que roda na máquina do OpenChamber sob um nome de host próprio, para que um navegador em outra máquina possa abri-lo. O aplicativo desktop usa um túnel para uma porta local e não precisa disso.",
  "settings.openchamber.portForward.field.template": "Modelo de host de encaminhamento",
  "settings.openchamber.portForward.field.templatePlaceholder": "oc--{port}.example.com",
  "settings.openchamber.portForward.field.templateInfo": "Precisa conter {port} exatamente uma vez. O túnel à frente do OpenChamber tem que rotear todo o curinga até aqui por HTTPS, e um certificado tem que cobri-lo. O SSL universal da Cloudflare cobre apenas um nível de curinga, então mantenha o modelo no mesmo nível do nome de host do OpenChamber.",
  "settings.openchamber.portForward.rejected": "Esse modelo não foi aceito. Ele precisa ser um nome de host simples contendo {port} exatamente uma vez, sem esquema, porta, caminho ou curinga.",
  "settings.openchamber.portForward.active": "Portas encaminhadas",
  "settings.openchamber.portForward.activeEmpty": "Nenhuma porta está sendo encaminhada.",
  "settings.openchamber.portForward.stop": "Parar",
  "settings.openchamber.portForward.stopAria": "Parar o encaminhamento da porta {port}",
  "settings.openchamber.portForward.warning": "Um servidor de desenvolvimento encaminhado fica acessível a qualquer pessoa que consiga alcançar o OpenChamber. Os encaminhamentos param quando o OpenChamber reinicia.",
  "settings.openchamber.portForward.unavailable": "Não foi possível ler o status do encaminhamento de portas.",
  ...
  "settings.notifications.page.toast.disableBackgroundFailed": "Não foi possível desativar as notificações em segundo plano",
  ...
  "settings.notifications.page.toast.backgroundDisabledCleanupFailed": "As notificações em segundo plano foram desativadas neste dispositivo, mas não foi possível remover o registro do servidor",
  ...
  "settings.openchamber.visual.section.followUpBehavior": "Comportamento das mensagens de acompanhamento",
  "settings.openchamber.visual.section.followUpBehaviorAria": "Comportamento das mensagens de acompanhamento",
  "settings.openchamber.visual.field.followUpBehaviorAria": "Comportamento das mensagens de acompanhamento: {option}",
  "settings.openchamber.visual.field.followUpBehaviorDescription": "Escolha o que acontece ao pressionar Enter em uma mensagem de acompanhamento enquanto o agente ainda está respondendo.",
  "settings.openchamber.visual.option.followUpBehavior.steer.label": "Redirecionar",
  "settings.openchamber.visual.option.followUpBehavior.queue.label": "Enfileirar",
