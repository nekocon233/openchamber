...
export const dict: Record<I18nKey, string> = {
  'chat.codexCommand.unsupported': "Este comando ou habilidade do Codex não está disponível aqui. Consulte o menu de comandos ou execute os comandos de terminal no Codex CLI.",
  'chat.codexCommand.diff': "Revisar alterações do espaço de trabalho",
  'chat.codexCommand.mention': "Mencionar um arquivo ou pasta",
  'chat.codexCommand.agents': "Explorar sessões de subagentes",
  'chat.codexCommand.fast': "Ativar ou desativar o modo rápido",
  'chat.codexCommand.plan': "Mudar para o modo de planejamento com instrução opcional",
  'chat.codexCommand.resume': "Retomar uma sessão salva",
  'chat.codexCommand.fork': "Criar uma ramificação da sessão atual",
  'chat.codexCommand.status': "Mostrar configurações da sessão",
  'chat.codexCommand.skills': "Explorar habilidades do Codex",
  'chat.codexCommand.mcp': "Mostrar servidores e ferramentas MCP do Codex",
  'chat.codexCommand.ps': "Mostrar terminais em segundo plano",
  'chat.codexCommand.stop': "Parar terminais em segundo plano",
  'chat.codexCommand.review': "Executar uma revisão de código do Codex",
  'chat.codexCommand.invalid': "Argumentos inválidos ou opção indisponível para {command}.",
  'chat.codexCommand.needsSession': "Abra uma sessão do Codex antes de executar este comando.",
  'chat.codexCommand.empty': "Nenhuma entrada.",
  'chat.codexCommand.failed': "Não foi possível executar o comando do Codex.",
  ...
  "mobile.sessions.section.pinned": "Fixadas",
  "mobile.sessions.status.running": "Em execução",
  ...
  "sessions.sidebar.header.displayMode.showPinned": "Mostrar seção de fixadas",
  ...
  "sessions.sidebar.activity.pinnedTitle": "fixadas",
  ...
  "chat.goal.dialog.budgetUnavailableCodex": "O Codex não informa o uso de tokens, então este objetivo não pode ter um orçamento de tokens.",
  "chat.compaction.auto": "Contexto comprimido automaticamente",
  "chat.compaction.manual": "Contexto comprimido",
  "chat.compaction.summary": "Resumo da conversa anterior",
  ...
  "chat.errorBoundary.chunkLoadDescription": "Uma atualização da interface não carregou por completo. Atualize a página para carregar a conversa mais recente.",
  ...
  "chat.errorBoundary.reloadAction": "Atualizar a página",
  ...
  'chat.questionCard.planExitTitle': "Revisar o plano",
  'chat.message.turnStopped': "Esta execução foi interrompida.",
  'chat.questionCard.planExitQuestion': "Aprovar este plano e iniciar a implementação?",
  'chat.questionCard.planExitApprove': "Aprovar e implementar",
  'chat.questionCard.planExitKeepPlanning': "Manter o modo de planejamento",
  ...
  "chat.chatInput.actions.queueMessageAria": "Mover mensagem para pendentes",
  ...
  "chat.chatInput.queuedMessages.title": "Mensagens na fila",
  "chat.chatInput.queuedMessages.toggleAria": "Alternar mensagens na fila",
  "chat.chatInput.queuedMessages.emptyText": "Prompt na fila",
  "chat.chatInput.queuedMessages.submitting": "Enviando…",
  "chat.chatInput.queuedMessages.queued": "Na fila",
  "chat.queuedMessage.queue": "Enfileirar",
  "chat.queuedMessage.queued": "Na fila",
  "chat.queuedMessage.unqueue": "Remover da fila",
  "chat.queuedMessage.sendFailed": "A mensagem não foi enviada e continua pendente.",
  ...
  "chat.chatInput.placeholder.nativeCli": "@ para arquivos; # para snippets; comandos / vão direto para a CLI",
  "chat.chatInput.placeholder.nativeCliCompact": "Use @ # para ajudantes",
  ...
  "chat.chatInput.toast.sendUnconfirmed": "Status de envio desconhecido — a mensagem pode já ter sido enviada. Verifique a conversa antes de tentar novamente.",
  "chat.chatInput.toast.sessionStatusUnavailable": "Não foi possível confirmar se a sessão está ociosa. A mensagem não foi enviada. Verifique sua conexão e tente novamente.",
  ...
  "chat.toolPart.concise.outputLinesOne": "1 linha",
  "chat.toolPart.concise.outputLinesMany": "{count} linhas",
  "chat.toolPart.concise.moreLinesOne": "Mostrar mais 1 linha",
  "chat.toolPart.concise.moreLinesMany": "Mostrar mais {count} linhas",
  "chat.toolPart.concise.fewerLines": "Mostrar menos linhas",
  "chat.toolPart.concise.toolCallsOne": "1 chamada de ferramenta",
  "chat.toolPart.concise.toolCallsMany": "{count} chamadas de ferramentas",
