...
export const thirdPartyIntegrationI18n = {
  en: {
    ...
    'settings.integrations.thirdParty.opencodeCodex.name': 'Codex',
    'settings.integrations.thirdParty.opencodeCodex.description': 'Run the official Codex agent on your ChatGPT plan. No API keys.',
  ...
  de: {
    ...
    'settings.integrations.thirdParty.opencodeCodex.name': 'Codex',
    'settings.integrations.thirdParty.opencodeCodex.description': 'Führe den offiziellen Codex-Agenten mit deinem ChatGPT-Plan aus. Ohne API-Keys.',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
  ...
  fr: {
    ...
    'settings.integrations.thirdParty.opencodeCodex.name': 'Codex',
    'settings.integrations.thirdParty.opencodeCodex.description': 'Exécutez l’agent Codex officiel avec votre forfait ChatGPT. Sans clés API.',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
  ...
  es: {
    ...
    'settings.integrations.thirdParty.opencodeCodex.name': 'Codex',
    'settings.integrations.thirdParty.opencodeCodex.description': 'Ejecuta el agente Codex oficial con tu plan de ChatGPT: sin claves API.',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
  ...
  ja: {
    ...
    'settings.integrations.thirdParty.opencodeCodex.name': 'Codex',
    'settings.integrations.thirdParty.opencodeCodex.description': '公式 Codex エージェントを ChatGPT プランで実行。API キーは不要です。',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
  ...
  ko: {
    ...
    'settings.integrations.thirdParty.opencodeCodex.name': 'Codex',
    'settings.integrations.thirdParty.opencodeCodex.description': 'ChatGPT 요금제로 공식 Codex 에이전트를 실행하세요. API 키는 필요 없습니다.',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
  ...
  pl: {
    ...
    'settings.integrations.thirdParty.opencodeCodex.name': 'Codex',
    'settings.integrations.thirdParty.opencodeCodex.description': 'Uruchom oficjalnego agenta Codex w ramach planu ChatGPT. Bez kluczy API.',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
  ...
  'pt-BR': {
    ...
    'settings.integrations.thirdParty.opencodeCodex.name': 'Codex',
    'settings.integrations.thirdParty.opencodeCodex.description': 'Use o agente Codex oficial no seu plano do ChatGPT. Sem chaves de API.',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
  ...
  uk: {
    ...
    'settings.integrations.thirdParty.opencodeCodex.name': 'Codex',
    'settings.integrations.thirdParty.opencodeCodex.description': 'Запускайте офіційного агента Codex за вашою підпискою ChatGPT. Без API-ключів.',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
  ...
  'zh-CN': {
    ...
    'settings.integrations.thirdParty.opencodeCodex.name': 'Codex',
    'settings.integrations.thirdParty.opencodeCodex.description': '用 ChatGPT 套餐运行官方 Codex 智能体，无需 API 密钥。',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
  ...
  'zh-TW': {
    ...
    'settings.integrations.thirdParty.opencodeCodex.name': 'Codex',
    'settings.integrations.thirdParty.opencodeCodex.description': '用 ChatGPT 方案執行官方 Codex 代理，無需 API 金鑰。',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
  ...
  'settings.integrations.experimentalWarning': 'Deneysel özellik. Provider politikalarına saygı göstermeye çalışıyoruz, ancak hesap kısıtlamaları ve askıya almalar her provider\'ın kararıdır. Entegrasyonları kendi riskinize kullanın.',
    ...
    'settings.integrations.thirdParty.opencodeCodex.name': 'Codex',
    'settings.integrations.thirdParty.opencodeCodex.description': 'Resmî Codex ajanını ChatGPT planınızla çalıştırın. API anahtarı gerekmez.',
    'settings.integrations.thirdParty.opencodeCursorOauth.name': 'Cursor',
