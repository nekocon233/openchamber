...
export const settingsDict = {
  ...
  "settings.openchamber.tunnel.description": "Налаштуйте безпечний віддалений доступ за допомогою швидких посилань, керованих тунелів Cloudflare або FRPC.",
  "settings.openchamber.tunnel.field.frpcProxyType": "Тип проксі FRPC",
  "settings.openchamber.tunnel.option.frpcProxyType.tcp": "TCP",
  "settings.openchamber.tunnel.option.frpcProxyType.http": "Віртуальний хост HTTP",
  "settings.openchamber.tunnel.field.frpcServerAddress": "Адреса сервера FRPS",
  "settings.openchamber.tunnel.field.frpcServerAddressPlaceholder": "IP-адреса або ім’я хоста (наприклад, 203.0.113.10)",
  "settings.openchamber.tunnel.field.frpcServerPort": "Порт керування FRPS",
  "settings.openchamber.tunnel.field.frpcRemotePort": "Віддалений порт FRPS",
  "settings.openchamber.tunnel.field.frpcPublicUrl": "Публічна URL-адреса HTTPS",
  "settings.openchamber.tunnel.field.frpcCustomDomain": "Власний домен FRPS",
  "settings.openchamber.tunnel.field.frpcCustomDomainPlaceholder": "Ім’я віртуального хоста (наприклад, vhost.example.com)",
  "settings.openchamber.tunnel.field.frpcPublicHostname": "Публічне ім’я хоста",
  "settings.openchamber.tunnel.field.frpcPublicHostnamePlaceholder": "Зовнішнє ім’я хоста (наприклад, openchamber.example.com)",
  "settings.openchamber.tunnel.field.frpcToken": "Токен FRPS",
  "settings.openchamber.tunnel.field.savedFrpcTokenPlaceholder": "Збережений токен доступний (можна замінити)",
  "settings.openchamber.tunnel.field.frpcLocalPort": "Автоматичний локальний порт OpenChamber",
  "settings.openchamber.tunnel.note.frpcProxyTypes": "Налаштуйте зіставлення порту TCP або тунель віртуального хоста HTTP через FRPS. Файл CA не потрібен; сертифікат FRPS автоматично перевіряється за допомогою сховища довіри хоста.",
  "settings.openchamber.tunnel.note.frpcTcpMapping": "FRPC пересилає незашифрований HTTP через віддалений порт. Укажіть точне зовнішнє джерело HTTPS, на якому термінатор TLS приймає з’єднання та пересилає їх на цей порт.",
  "settings.openchamber.tunnel.note.frpcHttpVhost": "FRPC реєструє власний домен у FRPS. Caddy або інший зворотний проксі-сервер може спрямовувати публічне ім’я хоста на це ім’я віртуального хоста FRPS.",
  "settings.openchamber.tunnel.toast.frpcEndpointRequired": "Введіть дійсну адресу сервера FRPS, порт керування, віддалений порт і публічну URL-адресу HTTPS.",
  "settings.openchamber.tunnel.toast.frpcHttpEndpointRequired": "Введіть дійсну адресу сервера FRPS, дійсний порт керування, власний домен і публічне ім’я хоста.",
  "settings.openchamber.tunnel.toast.frpcTokenRequired": "Потрібен токен FRPS.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.portForward.title": "Перенаправлення портів",
  "settings.openchamber.portForward.info": "Публікує сервер розробки, що працює на машині з OpenChamber, під власним іменем хоста, щоб браузер на іншій машині міг його відкрити. Десктопний застосунок натомість тунелює локальний порт і цього не потребує.",
  "settings.openchamber.portForward.field.template": "Шаблон хоста перенаправлення",
  "settings.openchamber.portForward.field.templatePlaceholder": "oc--{port}.example.com",
  "settings.openchamber.portForward.field.templateInfo": "Має містити {port} рівно один раз. Тунель перед OpenChamber повинен маршрутизувати весь шаблон із символом підстановки сюди через HTTPS, а сертифікат — покривати його. Universal SSL від Cloudflare покриває лише один рівень підстановки, тож тримайте шаблон на тому самому рівні, що й ім’я хоста OpenChamber.",
  "settings.openchamber.portForward.rejected": "Цей шаблон не прийнято. Він має бути простим іменем хоста, що містить {port} рівно один раз, без схеми, порту, шляху чи символу підстановки.",
  "settings.openchamber.portForward.active": "Перенаправлені порти",
  "settings.openchamber.portForward.activeEmpty": "Жоден порт не перенаправлено.",
  "settings.openchamber.portForward.stop": "Зупинити",
  "settings.openchamber.portForward.stopAria": "Зупинити перенаправлення порту {port}",
  "settings.openchamber.portForward.warning": "Перенаправлений сервер розробки доступний кожному, хто має доступ до OpenChamber. Перенаправлення припиняються після перезапуску OpenChamber.",
  "settings.openchamber.portForward.unavailable": "Не вдалося прочитати стан перенаправлення портів.",
  ...
  "settings.notifications.page.toast.disableBackgroundFailed": "Не вдалося вимкнути фонові сповіщення",
  ...
  "settings.notifications.page.toast.backgroundDisabledCleanupFailed": "Фонові сповіщення вимкнено на цьому пристрої, але не вдалося видалити реєстрацію із сервера",
  ...
  "settings.openchamber.visual.section.followUpBehavior": "Поведінка наступних повідомлень",
  "settings.openchamber.visual.section.followUpBehaviorAria": "Поведінка наступних повідомлень",
  "settings.openchamber.visual.field.followUpBehaviorAria": "Поведінка наступних повідомлень: {option}",
  "settings.openchamber.visual.field.followUpBehaviorDescription": "Виберіть, що відбувається, коли ви натискаєте Enter у наступному повідомленні, поки агент ще відповідає.",
  "settings.openchamber.visual.option.followUpBehavior.steer.label": "Спрямувати",
  "settings.openchamber.visual.option.followUpBehavior.queue.label": "Додати до черги",
