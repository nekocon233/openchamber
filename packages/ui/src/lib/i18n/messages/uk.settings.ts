...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.visual.field.conciseTranscript": "Розмова в стилі Claude Code",
  "settings.openchamber.visual.field.conciseTranscriptAria": "Показувати чат у стилі Claude Code",
