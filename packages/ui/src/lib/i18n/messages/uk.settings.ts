export const settingsDict = {
  ...
  "settings.openchamber.tunnel.description": "Налаштуйте безпечний віддалений доступ через підтримуваного постачальника тунелю.",
  ...
  "settings.openchamber.tunnel.field.frpcTrustedCaFile": "Довірений сертифікат ЦС",
  ...
  "settings.openchamber.tunnel.note.frpcProxyTypes": "Налаштуйте зіставлення порту TCP або тунель віртуального хоста HTTP через FRPS.",
  ...
  "settings.openchamber.tunnel.toast.frpcTrustedCaRequired": "Для перевірки сервера FRPS потрібен файл довіреного сертифіката ЦС.",
