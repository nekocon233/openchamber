...
export const dict: Record<I18nKey, string> = {
  'chat.codexCommand.unsupported': "Ця команда або навичка Codex тут недоступна. Перегляньте меню команд або виконайте термінальні команди в Codex CLI.",
  'chat.codexCommand.diff': "Переглянути зміни в робочому просторі",
  'chat.codexCommand.mention': "Згадати файл або папку",
  'chat.codexCommand.agents': "Переглянути сеанси підагентів",
  'chat.codexCommand.fast': "Увімкнути або вимкнути швидкий режим",
  'chat.codexCommand.plan': "Перейти до режиму планування з необов’язковим запитом",
  'chat.codexCommand.resume': "Продовжити збережений сеанс",
  'chat.codexCommand.fork': "Створити відгалуження поточного сеансу",
  'chat.codexCommand.status': "Показати налаштування сеансу",
  'chat.codexCommand.skills': "Переглянути навички Codex",
  'chat.codexCommand.mcp': "Показати сервери й інструменти MCP Codex",
  'chat.codexCommand.ps': "Показати фонові термінали",
  'chat.codexCommand.stop': "Зупинити фонові термінали",
  'chat.codexCommand.review': "Запустити перевірку коду Codex",
  'chat.codexCommand.invalid': "Неприпустимі аргументи або недоступний параметр для {command}.",
  'chat.codexCommand.needsSession': "Відкрийте сеанс Codex перед виконанням цієї команди.",
  'chat.codexCommand.empty': "Немає записів.",
  'chat.codexCommand.failed': "Не вдалося виконати команду Codex.",
  ...
  "mobile.sessions.section.pinned": "Закріплені",
  "mobile.sessions.status.running": "Виконується",
  ...
  "sessions.sidebar.header.displayMode.showPinned": "Показувати розділ закріплених",
  ...
  "sessions.sidebar.activity.pinnedTitle": "Закріплені",
  ...
  "chat.goal.dialog.budgetUnavailableCodex": "Codex не повідомляє про використання токенів, тому ця мета не може мати бюджету токенів.",
  "chat.compaction.auto": "Контекст автоматично стиснуто",
  "chat.compaction.manual": "Контекст стиснуто",
  "chat.compaction.summary": "Підсумок попередньої розмови",
  ...
  "chat.errorBoundary.chunkLoadDescription": "Оновлення інтерфейсу не завантажилося повністю. Оновіть сторінку, щоб завантажити найновіший інтерфейс чату.",
  ...
  "chat.errorBoundary.reloadAction": "Оновити сторінку",
  ...
  'chat.questionCard.planExitTitle': "Перегляд плану",
  'chat.message.turnStopped': "Поточне виконання зупинено.",
  'chat.questionCard.planExitQuestion': "Схвалити цей план і почати виконання?",
  'chat.questionCard.planExitApprove': "Схвалити й виконати",
  'chat.questionCard.planExitKeepPlanning': "Залишитися в режимі планування",
  ...
  "chat.chatInput.actions.queueMessageAria": "Відкласти повідомлення",
  ...
  "chat.chatInput.queuedMessages.title": "Повідомлення в черзі",
  "chat.chatInput.queuedMessages.toggleAria": "Перемкнути повідомлення в черзі",
  "chat.chatInput.queuedMessages.emptyText": "Запит у черзі",
  "chat.chatInput.queuedMessages.submitting": "Надсилання…",
  "chat.chatInput.queuedMessages.queued": "У черзі",
  "chat.queuedMessage.queue": "До черги",
  "chat.queuedMessage.queued": "У черзі",
  "chat.queuedMessage.unqueue": "Прибрати з черги",
  "chat.queuedMessage.sendFailed": "Повідомлення не надіслано, воно залишається у відкладених.",
  ...
  "chat.chatInput.placeholder.nativeCli": "@ для файлів; # для сніпетів; команди / йдуть напряму в CLI",
  "chat.chatInput.placeholder.nativeCliCompact": "Використовуйте @ # для помічників",
  ...
  "chat.chatInput.toast.sendUnconfirmed": "Стан надсилання невідомий — повідомлення, можливо, вже надіслано. Перевірте розмову перед повторною спробою.",
  "chat.chatInput.toast.sessionStatusUnavailable": "Не вдалося підтвердити, чи сесія неактивна. Повідомлення не надіслано. Перевірте з’єднання та повторіть спробу.",
  ...
  "chat.toolPart.concise.outputLinesOne": "1 рядок",
  "chat.toolPart.concise.outputLinesMany": "Рядків: {count}",
  "chat.toolPart.concise.moreLinesOne": "Показати ще 1 рядок",
  "chat.toolPart.concise.moreLinesMany": "Показати ще рядків: {count}",
  "chat.toolPart.concise.fewerLines": "Показати менше рядків",
  "chat.toolPart.concise.toolCallsOne": "1 виклик інструмента",
  "chat.toolPart.concise.toolCallsMany": "Викликів інструментів: {count}",
