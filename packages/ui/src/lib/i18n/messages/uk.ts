...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.queuedMessage.title": "Чернетки ({count})",
  "chat.queuedMessage.edit": "Редагувати",
  "chat.queuedMessage.send": "Надіслати",
  "chat.queuedMessage.sendFailed": "Чернетку не надіслано, вона залишається збереженою.",
  "chat.queuedMessage.removeAria": "Видалити чернетку",
  "chat.queuedMessage.reorderAria": "Перетягніть, щоб змінити порядок чернеток",
  ...
  "chat.chatInput.actions.queueMessageAria": "Зберегти повідомлення як чернетку",
