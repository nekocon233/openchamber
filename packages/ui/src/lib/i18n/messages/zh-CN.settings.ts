...
export const settingsDict = {
  ...
  'settings.openchamber.tunnel.description': '通过快速链接、托管的 Cloudflare 隧道或 FRPC 配置安全远程访问。',
  'settings.openchamber.tunnel.field.frpcProxyType': 'FRPC 代理类型',
  'settings.openchamber.tunnel.option.frpcProxyType.tcp': 'TCP',
  'settings.openchamber.tunnel.option.frpcProxyType.http': 'HTTP 虚拟主机',
  'settings.openchamber.tunnel.field.frpcServerAddress': 'FRPS 服务器地址',
  'settings.openchamber.tunnel.field.frpcServerAddressPlaceholder': 'IP 地址或主机名（例如 203.0.113.10）',
  'settings.openchamber.tunnel.field.frpcServerPort': 'FRPS 控制端口',
  'settings.openchamber.tunnel.field.frpcRemotePort': 'FRPS 远端端口',
  'settings.openchamber.tunnel.field.frpcPublicUrl': '公网 HTTPS URL',
  'settings.openchamber.tunnel.field.frpcCustomDomain': 'FRPS 自定义域名',
  'settings.openchamber.tunnel.field.frpcCustomDomainPlaceholder': '虚拟主机名（例如 vhost.example.com）',
  'settings.openchamber.tunnel.field.frpcPublicHostname': '公网主机名',
  'settings.openchamber.tunnel.field.frpcPublicHostnamePlaceholder': '外部主机名（例如 openchamber.example.com）',
  'settings.openchamber.tunnel.field.frpcToken': 'FRPS Token',
  'settings.openchamber.tunnel.field.savedFrpcTokenPlaceholder': '已有保存的 Token（可选覆盖）',
  'settings.openchamber.tunnel.field.frpcLocalPort': '自动获取的 OpenChamber 本地端口',
  'settings.openchamber.tunnel.note.frpcProxyTypes': '通过 FRPS 配置 TCP 端口映射或 HTTP 虚拟主机隧道。无需 CA 文件；自动使用宿主信任根验证 FRPS 证书。',
  'settings.openchamber.tunnel.note.frpcTcpMapping': 'FRPC 会通过远端端口转发明文 HTTP。请输入 TLS 终止器监听并转发到该端口的确切外部 HTTPS 源地址。',
  'settings.openchamber.tunnel.note.frpcHttpVhost': 'FRPC 会向 FRPS 注册自定义域名。Caddy 或其他反向代理可将公网主机名路由到该 FRPS 虚拟主机名。',
  'settings.openchamber.tunnel.toast.frpcEndpointRequired': '请输入有效的 FRPS 服务器地址、控制端口、远端端口和公网 HTTPS URL。',
  'settings.openchamber.tunnel.toast.frpcHttpEndpointRequired': '请输入有效的 FRPS 服务器地址、控制端口、自定义域名和公网主机名。',
  'settings.openchamber.tunnel.toast.frpcTokenRequired': '必须填写 FRPS Token。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.portForward.title': '端口转发',
  'settings.openchamber.portForward.info': '把运行在 OpenChamber 主机上的开发服务器发布到一个独立域名下，这样另一台机器的浏览器就能打开它。桌面应用改用本地端口隧道，不需要这项设置。',
  'settings.openchamber.portForward.field.template': '转发域名模板',
  'settings.openchamber.portForward.field.templatePlaceholder': 'oc--{port}.example.com',
  'settings.openchamber.portForward.field.templateInfo': '必须且只能包含一个 {port}。OpenChamber 前面的隧道要把整个通配符经 HTTPS 路由回来，并且需要有证书覆盖它。Cloudflare 的 Universal SSL 只覆盖一级通配符，所以模板要和 OpenChamber 的域名保持同级。',
  'settings.openchamber.portForward.rejected': '该模板未被接受。它必须是一个裸域名，且只包含一个 {port}，不能带协议、端口、路径或通配符。',
  'settings.openchamber.portForward.active': '已转发的端口',
  'settings.openchamber.portForward.activeEmpty': '当前没有转发任何端口。',
  'settings.openchamber.portForward.stop': '停止',
  'settings.openchamber.portForward.stopAria': '停止转发端口 {port}',
  'settings.openchamber.portForward.warning': '转发后的开发服务器，任何能访问 OpenChamber 的人都能打开。OpenChamber 重启后转发会全部停止。',
  'settings.openchamber.portForward.unavailable': '无法读取端口转发状态。',
  ...
  'settings.notifications.page.toast.disableBackgroundFailed': '关闭后台通知失败',
  'settings.notifications.page.toast.backgroundEnabled': '后台通知已启用',
  'settings.notifications.page.toast.backgroundDisabled': '后台通知已关闭',
  'settings.notifications.page.toast.backgroundDisabledCleanupFailed': '此设备上的后台通知已关闭，但无法删除服务器注册',
  ...
  'settings.openchamber.visual.section.followUpBehavior': '后续消息行为',
  'settings.openchamber.visual.section.followUpBehaviorAria': '后续消息行为',
  'settings.openchamber.visual.field.followUpBehaviorAria': '后续消息行为：{option}',
  'settings.openchamber.visual.field.followUpBehaviorDescription': '选择在智能体仍在响应时，按下 Enter 发送后续消息所执行的操作。',
