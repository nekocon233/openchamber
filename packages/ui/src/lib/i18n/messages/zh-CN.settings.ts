export const settingsDict = {
  ...
  'settings.openchamber.tunnel.description': '通过受支持的隧道提供商配置安全远程访问。',
  ...
  'settings.openchamber.tunnel.field.frpcTrustedCaFile': '受信任的 CA 证书',
  ...
  'settings.openchamber.tunnel.note.frpcProxyTypes': '通过 FRPS 配置 TCP 端口映射或 HTTP 虚拟主机隧道。',
  ...
  'settings.openchamber.tunnel.toast.frpcTrustedCaRequired': '需要受信任的 CA 证书文件来验证 FRPS 服务器。',
