...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.browser.devServers.remoteOnly': '它们运行在托管 OpenChamber 的那台机器上。转发其中一个即可在此打开。',
  'contextPanel.browser.devServers.remoteOnlyUnconfigured': '它们运行在托管 OpenChamber 的那台机器上。请先在设置中配置转发域名模板，才能在此打开。',
  'contextPanel.browser.portForward.start': '转发',
  'contextPanel.browser.portForward.starting': '正在开启…',
  'contextPanel.browser.portForward.stop': '停止转发',
  'contextPanel.browser.portForward.startFailed': '无法开启转发',
  'contextPanel.browser.portForward.stopFailed': '无法停止转发',
  'contextPanel.browser.portForward.notForwarded': '端口 {port} 尚未转发',
  'contextPanel.browser.portForward.notForwardedHint': '它运行在 OpenChamber 所在的机器上。转发后即可在此打开。',
  'contextPanel.browser.portForward.unconfigured': '尚未设置端口转发',
  'contextPanel.browser.portForward.unconfiguredHint': '要打开另一台机器上的开发服务器，请先在设置中配置转发域名模板。',
  'contextPanel.browser.portForward.exposureWarning': '转发后的开发服务器，任何能访问 OpenChamber 的人都能打开。',
  ...
  'chat.queuedMessage.title': '暂存（{count}）',
  'chat.queuedMessage.edit': '编辑',
  'chat.queuedMessage.send': '发送',
  ...
  'chat.queuedMessage.removeAria': '删除暂存消息',
  'chat.queuedMessage.reorderAria': '拖动以重新排列暂存消息',
