...
export const dict: Record<I18nKey, string> = {
  'chat.codexCommand.unsupported': "此 Codex 命令或技能当前不可用。请查看命令菜单，或在 Codex CLI 中运行终端命令。",
  'chat.codexCommand.diff': "查看工作区改动",
  'chat.codexCommand.mention': "引用文件或文件夹",
  'chat.codexCommand.agents': "浏览子智能体会话",
  'chat.codexCommand.fast': "切换快速模式",
  'chat.codexCommand.plan': "切换到计划模式，可附带任务描述",
  'chat.codexCommand.resume': "恢复已有会话",
  'chat.codexCommand.fork': "从当前会话创建分支",
  'chat.codexCommand.status': "查看会话设置",
  'chat.codexCommand.skills': "浏览 Codex 技能",
  'chat.codexCommand.mcp': "查看 Codex 的 MCP 服务器和工具",
  'chat.codexCommand.ps': "查看后台终端",
  'chat.codexCommand.stop': "停止后台终端",
  'chat.codexCommand.review': "运行 Codex 代码审查",
  'chat.codexCommand.invalid': "{command} 的参数无效或所选选项不可用。",
  'chat.codexCommand.needsSession': "请先打开一个 Codex 会话再运行此命令。",
  'chat.codexCommand.empty': "没有条目。",
  'chat.codexCommand.failed': "无法执行 Codex 命令。",
  ...
  'mobile.sessions.section.pinned': '已置顶',
  'mobile.sessions.status.running': '运行中',
  ...
  'sessions.sidebar.activity.pinnedTitle': '已置顶',
  ...
  'chat.goal.dialog.budgetUnavailableCodex': 'Codex 不报告令牌用量，因此此目标无法设置令牌预算。',
  'chat.compaction.auto': '上下文已自动压缩',
  'chat.compaction.manual': '上下文已压缩',
  'chat.compaction.summary': '之前对话的摘要',
  ...
  'chat.questionCard.planExitTitle': "确认计划",
  'chat.message.turnStopped': "本轮执行已停止。",
  'chat.questionCard.planExitQuestion': "是否批准此计划并开始执行？",
  'chat.questionCard.planExitApprove': "批准并执行",
  'chat.questionCard.planExitKeepPlanning': "保持计划模式",
  ...
  'chat.chatInput.actions.queueMessageAria': '将消息加入暂存',
  ...
  'chat.chatInput.queuedMessages.title': '排队消息',
  'chat.chatInput.queuedMessages.toggleAria': '展开或收起排队消息',
  'chat.chatInput.queuedMessages.emptyText': '排队中的提示词',
  'chat.chatInput.queuedMessages.submitting': '发送中…',
  'chat.chatInput.queuedMessages.queued': '已排队',
  'chat.queuedMessage.queue': '入队',
  'chat.queuedMessage.queued': '已入队',
  'chat.queuedMessage.unqueue': '取消入队',
  'chat.queuedMessage.sendFailed': '消息未发送，仍保留在暂存列表中。',
  ...
  'chat.chatInput.placeholder.nativeCli': '@ 用于文件；# 用于代码片段；/ 命令直接交给 CLI',
  'chat.chatInput.placeholder.nativeCliCompact': '使用 @ # 辅助',
  ...
  'chat.chatInput.toast.sendUnconfirmed': '发送状态未知，消息可能已发送。请检查会话后再重试。',
  'chat.chatInput.toast.sessionStatusUnavailable': '无法确认会话是否空闲，消息未发送。请检查连接后重试。',
  ...
  'chat.toolPart.concise.moreLinesOne': '再显示 1 行',
  'chat.toolPart.concise.moreLinesMany': '再显示 {count} 行',
  'chat.toolPart.concise.fewerLines': '收起',
  'chat.toolPart.concise.toolCallsOne': '1 次工具调用',
  'chat.toolPart.concise.toolCallsMany': '{count} 次工具调用',
  'chat.todo.total': '总计',
