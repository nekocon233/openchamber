...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.queuedMessage.sendFailed': '草稿未发送，仍保留在草稿列表中。',
  'chat.queuedMessage.removeAria': '删除草稿',
  'chat.queuedMessage.reorderAria': '拖动以重新排列草稿',
  ...
  'chat.chatInput.actions.queueMessageAria': '将消息保存为草稿',
