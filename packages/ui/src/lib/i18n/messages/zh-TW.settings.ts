...
export const settingsDict = {
  ...
  'settings.openchamber.tunnel.description': '透過快速連結、受管理的 Cloudflare 通道或 FRPC 設定安全遠端存取。',
  'settings.openchamber.tunnel.field.frpcProxyType': 'FRPC 代理類型',
  'settings.openchamber.tunnel.option.frpcProxyType.tcp': 'TCP',
  'settings.openchamber.tunnel.option.frpcProxyType.http': 'HTTP 虛擬主機',
  'settings.openchamber.tunnel.field.frpcServerAddress': 'FRPS 伺服器位址',
  'settings.openchamber.tunnel.field.frpcServerAddressPlaceholder': 'IP 位址或主機名稱（例如 203.0.113.10）',
  'settings.openchamber.tunnel.field.frpcServerPort': 'FRPS 控制連接埠',
  'settings.openchamber.tunnel.field.frpcRemotePort': 'FRPS 遠端連接埠',
  'settings.openchamber.tunnel.field.frpcPublicUrl': '公開 HTTPS URL',
  'settings.openchamber.tunnel.field.frpcCustomDomain': 'FRPS 自訂網域',
  'settings.openchamber.tunnel.field.frpcCustomDomainPlaceholder': '虛擬主機名稱（例如 vhost.example.com）',
  'settings.openchamber.tunnel.field.frpcPublicHostname': '公開主機名稱',
  'settings.openchamber.tunnel.field.frpcPublicHostnamePlaceholder': '外部主機名稱（例如 openchamber.example.com）',
  'settings.openchamber.tunnel.field.frpcToken': 'FRPS Token',
  'settings.openchamber.tunnel.field.savedFrpcTokenPlaceholder': '已有儲存的 Token（可選擇取代）',
  'settings.openchamber.tunnel.field.frpcLocalPort': '自動取得的 OpenChamber 本機連接埠',
  'settings.openchamber.tunnel.note.frpcProxyTypes': '透過 FRPS 設定 TCP 連接埠對應或 HTTP 虛擬主機通道。無需 CA 檔案；自動使用主機信任根驗證 FRPS 憑證。',
  'settings.openchamber.tunnel.note.frpcTcpMapping': 'FRPC 會透過遠端連接埠轉送未加密的 HTTP。請輸入 TLS 終止器監聽並轉送至該連接埠的確切外部 HTTPS 來源。',
  'settings.openchamber.tunnel.note.frpcHttpVhost': 'FRPC 會向 FRPS 註冊自訂網域。Caddy 或其他反向 Proxy 可將公開主機名稱路由至該 FRPS 虛擬主機名稱。',
  'settings.openchamber.tunnel.toast.frpcEndpointRequired': '請輸入有效的 FRPS 伺服器位址、控制連接埠、遠端連接埠和公開 HTTPS URL。',
  'settings.openchamber.tunnel.toast.frpcHttpEndpointRequired': '請輸入有效的 FRPS 伺服器位址、控制連接埠、自訂網域和公開主機名稱。',
  'settings.openchamber.tunnel.toast.frpcTokenRequired': '必須填寫 FRPS Token。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.portForward.title': '連接埠轉發',
  'settings.openchamber.portForward.info': '把執行在 OpenChamber 主機上的開發伺服器發布到一個獨立網域下，這樣另一台機器的瀏覽器就能開啟它。桌面應用程式改用本機連接埠隧道，不需要這項設定。',
  'settings.openchamber.portForward.field.template': '轉發網域範本',
  'settings.openchamber.portForward.field.templatePlaceholder': 'oc--{port}.example.com',
  'settings.openchamber.portForward.field.templateInfo': '必須且只能包含一個 {port}。OpenChamber 前面的隧道要把整個萬用字元經 HTTPS 路由回來，並且需要有憑證涵蓋它。Cloudflare 的 Universal SSL 只涵蓋一級萬用字元，所以範本要和 OpenChamber 的網域保持同級。',
  'settings.openchamber.portForward.rejected': '該範本未被接受。它必須是一個裸網域，且只包含一個 {port}，不能帶通訊協定、連接埠、路徑或萬用字元。',
  'settings.openchamber.portForward.active': '已轉發的連接埠',
  'settings.openchamber.portForward.activeEmpty': '目前沒有轉發任何連接埠。',
  'settings.openchamber.portForward.stop': '停止',
  'settings.openchamber.portForward.stopAria': '停止轉發連接埠 {port}',
  'settings.openchamber.portForward.warning': '轉發後的開發伺服器，任何能存取 OpenChamber 的人都能開啟。OpenChamber 重新啟動後轉發會全部停止。',
  'settings.openchamber.portForward.unavailable': '無法讀取連接埠轉發狀態。',
  ...
  'settings.notifications.page.toast.disableBackgroundFailed': '關閉背景通知失敗',
  'settings.notifications.page.toast.backgroundEnabled': '背景通知已啟用',
  'settings.notifications.page.toast.backgroundDisabled': '背景通知已關閉',
  'settings.notifications.page.toast.backgroundDisabledCleanupFailed': '已關閉此裝置上的背景通知，但無法刪除伺服器註冊',
  ...
  'settings.openchamber.visual.section.followUpBehavior': '後續訊息行為',
  'settings.openchamber.visual.section.followUpBehaviorAria': '後續訊息行為',
  'settings.openchamber.visual.field.followUpBehaviorAria': '後續訊息行為：{option}',
  'settings.openchamber.visual.field.followUpBehaviorDescription': '選擇在代理仍在回應時，於後續訊息中按下 Enter 所執行的操作。',
  'settings.openchamber.visual.option.followUpBehavior.steer.label': '引導',
  'settings.openchamber.visual.option.followUpBehavior.queue.label': '加入佇列',
