...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.browser.devServers.remoteOnly': '它們執行在託管 OpenChamber 的那台機器上。轉發其中一個即可在此開啟。',
  'contextPanel.browser.devServers.remoteOnlyUnconfigured': '它們執行在託管 OpenChamber 的那台機器上。請先在設定中配置轉發網域範本，才能在此開啟。',
  'contextPanel.browser.portForward.start': '轉發',
  'contextPanel.browser.portForward.starting': '正在開啟…',
  'contextPanel.browser.portForward.stop': '停止轉發',
  'contextPanel.browser.portForward.startFailed': '無法開啟轉發',
  'contextPanel.browser.portForward.stopFailed': '無法停止轉發',
  'contextPanel.browser.portForward.notForwarded': '連接埠 {port} 尚未轉發',
  'contextPanel.browser.portForward.notForwardedHint': '它執行在 OpenChamber 所在的機器上。轉發後即可在此開啟。',
  'contextPanel.browser.portForward.unconfigured': '尚未設定連接埠轉發',
  'contextPanel.browser.portForward.unconfiguredHint': '要開啟另一台機器上的開發伺服器，請先在設定中配置轉發網域範本。',
  'contextPanel.browser.portForward.exposureWarning': '轉發後的開發伺服器，任何能存取 OpenChamber 的人都能開啟。',
  ...
  'chat.queuedMessage.title': '暫存（{count}）',
  'chat.queuedMessage.edit': '編輯',
  'chat.queuedMessage.send': '傳送',
  ...
  'chat.queuedMessage.removeAria': '刪除暫存訊息',
  'chat.queuedMessage.reorderAria': '拖曳以重新排列暫存訊息',
