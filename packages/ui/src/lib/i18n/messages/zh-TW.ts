...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.queuedMessage.title': '草稿（{count}）',
  'chat.queuedMessage.edit': '編輯',
  'chat.queuedMessage.send': '傳送',
  'chat.queuedMessage.sendFailed': '草稿未傳送，仍保留在草稿清單中。',
  'chat.queuedMessage.removeAria': '刪除草稿',
  'chat.queuedMessage.reorderAria': '拖曳以重新排列草稿',
  ...
  'chat.chatInput.actions.queueMessageAria': '將訊息儲存為草稿',
