...
export const dict: Record<I18nKey, string> = {
  'chat.codexCommand.unsupported': "此 Codex 命令或技能目前無法使用。請檢視命令選單，或在 Codex CLI 中執行終端機命令。",
  'chat.codexCommand.diff': "檢視工作區變更",
  'chat.codexCommand.mention': "引用檔案或資料夾",
  'chat.codexCommand.agents': "瀏覽子代理工作階段",
  'chat.codexCommand.fast': "切換快速模式",
  'chat.codexCommand.plan': "切換至計畫模式，可附帶任務描述",
  'chat.codexCommand.resume': "繼續既有工作階段",
  'chat.codexCommand.fork': "從目前工作階段建立分支",
  'chat.codexCommand.status': "檢視工作階段設定",
  'chat.codexCommand.skills': "瀏覽 Codex 技能",
  'chat.codexCommand.mcp': "檢視 Codex 的 MCP 伺服器和工具",
  'chat.codexCommand.ps': "檢視背景終端機",
  'chat.codexCommand.stop': "停止背景終端機",
  'chat.codexCommand.review': "執行 Codex 程式碼審查",
  'chat.codexCommand.invalid': "{command} 的參數無效或所選選項無法使用。",
  'chat.codexCommand.needsSession': "請先開啟 Codex 工作階段再執行此命令。",
  'chat.codexCommand.empty': "沒有項目。",
  'chat.codexCommand.failed': "無法執行 Codex 命令。",
  ...
  'mobile.sessions.section.pinned': '已釘選',
  'mobile.sessions.status.running': '執行中',
  ...
  'sessions.sidebar.header.displayMode.showPinned': '顯示釘選部分',
  'sessions.sidebar.header.displayMode.showChats': '顯示聊天分組',
  ...
  'sessions.sidebar.activity.pinnedTitle': '已釘選',
  ...
  'chat.goal.dialog.budgetUnavailableCodex': 'Codex 不會回報權杖用量，因此此目標無法設定權杖預算。',
  'chat.compaction.auto': '上下文已自動壓縮',
  'chat.compaction.manual': '上下文已壓縮',
  'chat.compaction.summary': '先前對話的摘要',
  ...
  'chat.questionCard.planExitTitle': "確認計畫",
  'chat.message.turnStopped': "本輪執行已停止。",
  'chat.questionCard.planExitQuestion': "是否核准此計畫並開始執行？",
  'chat.questionCard.planExitApprove': "核准並執行",
  'chat.questionCard.planExitKeepPlanning': "維持計畫模式",
  ...
  'chat.chatInput.actions.queueMessageAria': '將訊息加入暫存',
  ...
  'chat.chatInput.queuedMessages.title': '佇列訊息',
  'chat.chatInput.queuedMessages.toggleAria': '展開或收合佇列訊息',
  'chat.chatInput.queuedMessages.emptyText': '佇列中的提示詞',
  'chat.chatInput.queuedMessages.submitting': '傳送中…',
  'chat.chatInput.queuedMessages.queued': '已加入佇列',
  'chat.queuedMessage.queue': '加入佇列',
  'chat.queuedMessage.queued': '已加入佇列',
  'chat.queuedMessage.unqueue': '取消加入佇列',
  'chat.queuedMessage.sendFailed': '訊息未傳送，仍保留在暫存清單中。',
  ...
  'chat.chatInput.placeholder.nativeCli': '@ 用於檔案；# 用於程式片段；/ 命令直接交給 CLI',
  'chat.chatInput.placeholder.nativeCliCompact': '使用 @ # 輔助',
  ...
  'chat.chatInput.toast.sendUnconfirmed': '傳送狀態未知，訊息可能已送出。請檢查工作階段後再重試。',
  'chat.chatInput.toast.sessionStatusUnavailable': '無法確認工作階段是否閒置，訊息尚未傳送。請檢查連線後重試。',
  ...
  'chat.toolPart.concise.moreLinesOne': '再顯示 1 行',
  'chat.toolPart.concise.moreLinesMany': '再顯示 {count} 行',
  'chat.toolPart.concise.fewerLines': '收合',
  'chat.toolPart.concise.toolCallsOne': '1 次工具呼叫',
  'chat.toolPart.concise.toolCallsMany': '{count} 次工具呼叫',
  'chat.todo.total': '總計',
