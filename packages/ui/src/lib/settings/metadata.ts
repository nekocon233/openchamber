...
export const SETTINGS_PAGE_METADATA: readonly SettingsPageMeta[] = [
  ...
  { slug: 'tunnel', title: 'External Tunnel', group: 'projects', kind: 'single', keywords: ['tunnel', 'external', 'cloudflare', 'frpc', 'frps', 'qr', 'remote', 'mobile', 'share'], isAvailable: (ctx) => !ctx.isVSCode && ctx.isHostLocalOrigin },
