...
const createGit = async (directory, { allowUnsafeSshCommand = false, allowUnsafeCredentialHelper = false, allowUnsafeEditor = false, stallTimeoutMs = 0 } = {}) => {
  ...
  const unsafe = hasCustomBinary || allowUnsafeSshCommand || allowUnsafeEditor || allowUnsafeCredentialHelper
    ? {
