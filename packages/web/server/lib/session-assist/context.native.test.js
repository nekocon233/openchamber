...
import { excerpt, loadAssistContext as loadContext } from './context.js';

import { buildAssistPrompt } from './prompt.js';

const loadAssistContext = (options) => loadContext({ ...options, native: true, readPage: ({ limit, cursor }) => options.readPage({ limit, before: cursor }) });
